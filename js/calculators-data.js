...
const CALCULATORS = [
  ...
  // ---------------- HEALTH & FITNESS ----------------
  {
    ...
    faq: [
      ...
      { q: "Are 'body index calculator,' 'mass index calculator,' and 'biomass index calculator' the same as BMI?", a: "Yes - these are all informal or misremembered versions of the same search: body mass index (BMI). This calculator computes standard BMI from height and weight, regardless of which of these phrasings you used to find it." },
    ],
