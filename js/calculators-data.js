...
const CALCULATORS = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does it mean if the percentage change is 0%?", a: "It means the starting and ending values are identical - there was no increase or decrease. Entering 80 for both the starting and ending value returns 0%." },
      { q: "How do I calculate the percentage change from 50 to 75?", a: "(75 − 50) ÷ 50 × 100 = 50%. The ending value is 50% higher than the starting value." },
      { q: "Is 'percent change' the same as 'percent difference'?", a: "Not quite - percentage change treats one value as the original and the other as the new value, so the order matters (going from 50 to 100 is +100%, but 100 to 50 is −50%). Percent difference is typically symmetric, comparing two values against their average rather than treating either as the baseline." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the median of an even-numbered list?", a: "Average the two middle values after sorting. For 4, 8, 15, 16, 23, 42 (already sorted, 6 numbers), the two middle values are 15 and 16, so the median is (15+16)/2 = 15.5." },
      { q: "Can I paste a very long list of numbers?", a: "Yes - there's no fixed limit on how many numbers you enter; separate them with commas, spaces, or new lines and the calculator will sum, average, and find the median across the entire list." },
      { q: "Why is my average so different from my median?", a: "A large gap usually means outliers are pulling the mean away from the bulk of the data. For 1, 2, 3, 4, 100: the mean is 22 but the median is 3 - the median better represents the 'typical' value when extreme numbers are present." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Is this calculator using an approximation or the true digits of pi?", a: "The true, mathematically correct digits - pi's digits up to any given precision are a fixed, known sequence (not an approximation), so the first 20 digits shown here will always match any other correct source." },
      { q: "What are the digits of pi to 5 decimal places?", a: "3.14159 - useful as a quick, memorable level of precision for everyday estimation, such as circle area or circumference calculations." },
      { q: "Is pi digits calculator the same as a pi generator or pi finder?", a: "Yes - all of these describe the same task of displaying pi's decimal expansion to a chosen number of digits, which is exactly what this tool does." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens if the divisor is 0?", a: "Division by zero is undefined, so entering 0 as the divisor won't produce a valid quotient - always use a nonzero divisor." },
      { q: "How do I do long division for 987 ÷ 7?", a: "9÷7 = 1 remainder 2; bring down the 8 to make 28, 28÷7 = 4 remainder 0; bring down the 7 to make 7, 7÷7 = 1 remainder 0. The quotient is 141 with no remainder." },
      { q: "Is 'long division' the same as 'synthetic division'?", a: "No - long division (shown here) works with plain numbers digit by digit. Synthetic division is a shortcut method specifically for dividing polynomials by a linear factor, using only coefficients." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many partial products will there be?", a: "One partial product per digit in the second number - multiplying by a 2-digit number produces 2 partial products, a 3-digit number produces 3, and so on, before they're all added together." },
      { q: "What's 234 × 56 using long multiplication?", a: "234 × 6 = 1,404 (ones-digit partial product), 234 × 5 = 1,170 shifted one place left = 11,700 (tens-digit partial product). Adding them: 1,404 + 11,700 = 13,104." },
      { q: "Is long multiplication the same as the standard column multiplication taught in school?", a: "Yes - 'long multiplication,' 'column multiplication,' and 'the standard algorithm' all refer to the same method of multiplying digit by digit and summing shifted partial products." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What if the two numbers share no common factors besides 1?", a: "Then their GCD is 1 (they're called coprime), and their LCM is simply the product of the two numbers - for example, GCD(8, 9) = 1 and LCM(8, 9) = 72." },
      { q: "What's the GCD and LCM of two identical numbers, like 15 and 15?", a: "Both the GCD and LCM equal that number itself - GCD(15, 15) = 15 and LCM(15, 15) = 15, since a number always divides itself evenly." },
      { q: "Is a 'GCF' the same as a 'GCD'?", a: "Yes - 'greatest common factor' (GCF) and 'greatest common divisor' (GCD) are two names for the same value: the largest number that divides evenly into both inputs." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's a special case for factoring the number 1?", a: "1 has only one factor - itself. It's neither prime nor composite by mathematical convention, since primality requires exactly two distinct factors (1 and itself)." },
      { q: "How many factors does a prime number have?", a: "Exactly two: 1 and the number itself. Entering a prime like 17 returns only the factors 1 and 17." },
      { q: "Is 'prime factorization' the same as 'listing all factors'?", a: "No - prime factorization breaks a number down into only its prime building blocks (like 360 = 2³×3²×5), while the full factor list includes every number that divides it evenly, including composite divisors like 6, 12, and 90." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does it mean if t is negative?", a: "A negative t simply means Group 1's mean is lower than Group 2's mean - the sign reflects direction, not strength. Only the magnitude (|t|) matters for judging how far apart the groups are." },
      { q: "How are degrees of freedom calculated for this test?", a: "For the pooled two-sample t-test, degrees of freedom = n1 + n2 − 2. With 30 people in each group, that's 30 + 30 − 2 = 58 degrees of freedom." },
      { q: "What if my two groups have very different sample sizes?", a: "The pooled standard deviation formula already weights each group's variance by its own sample size, so unequal n1 and n2 are handled correctly - just be aware that if the group variances are also very different, an unequal-variance (Welch's) t-test may be more appropriate than this pooled version." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can Cohen's d be negative?", a: "Yes - a negative d just means Group 1's mean is lower than Group 2's mean. The sign shows direction; researchers usually report the absolute value when only magnitude matters." },
      { q: "What's an example calculation of Cohen's d?", a: "With mean1=105, sd1=15, mean2=100, sd2=14, and equal sample sizes, the pooled SD is about 14.51, so d = (105−100)/14.51 ≈ 0.34 - a small-to-medium effect." },
      { q: "Is Cohen's d the same thing as a correlation coefficient?", a: "No, though they're related and convertible. Cohen's d expresses a difference between two group means in standard-deviation units, while a correlation coefficient (like r) measures how strongly two continuous variables move together - both quantify effect size but on different scales." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does it mean if the two groups have completely non-overlapping ranks?", a: "That's the most extreme possible result - if every value in one group ranks below every value in the other, U for the lower-ranked group is 0, indicating the strongest possible separation between the groups." },
      { q: "How are tied values handled when ranking?", a: "Tied values are given the average of the ranks they would have occupied - for example, if two values tie for 3rd and 4th place, both receive a rank of 3.5, keeping the total sum of ranks consistent." },
      { q: "Is the Mann-Whitney U test the same as the Wilcoxon rank-sum test?", a: "Yes - they're mathematically equivalent tests with different names; the Wilcoxon rank-sum statistic can be converted directly to the Mann-Whitney U statistic and both compare two independent groups using rank order." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens to a geometric series if the ratio r is between -1 and 1?", a: "Each term shrinks toward zero, and while this calculator computes the sum of a finite number of terms n, an infinite geometric series with |r| < 1 would converge to a finite total of a1 / (1 − r)." },
      { q: "Can the common difference or ratio be negative?", a: "Yes - a negative common difference produces a decreasing arithmetic sequence (like 10, 7, 4, 1...), and a negative common ratio produces a geometric sequence that alternates sign each term (like 2, -6, 18, -54...)." },
      { q: "Is a Fibonacci sequence the same as an arithmetic or geometric sequence?", a: "No - a Fibonacci sequence adds the two previous terms to get the next one (1, 1, 2, 3, 5, 8...), which is neither a constant difference (arithmetic) nor a constant ratio (geometric), so this calculator doesn't cover it." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How does the expected draws change as n grows larger?", a: "It grows roughly as n × ln(n), so doubling n more than doubles the expected number of draws - for 100 items, expected draws are about 519, far more than double the ~14.7 draws needed for 6 items." },
      { q: "What's the minimum possible number of draws to collect all n items?", a: "n draws - that's the theoretical best case where every single draw happens to be a new, previously uncollected item. The expected value calculated here is always higher than this minimum, since collisions with already-collected items are likely." },
      { q: "Is this the same math used for calculating trading card or loot box collection odds?", a: "Yes - the coupon collector's problem is the standard model for how many random pulls it takes to complete a full set, whether that's cereal box prizes, trading cards, or in-game loot drops with equal drop rates." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the area and volume ratio for a scale factor of 1?", a: "Both ratios equal 1 (1:1) - a scale factor of 1 means the two figures are congruent (identical size), so there's no change in area (1²=1) or volume (1³=1)." },
      { q: "If a model is built at 1:10 scale, how much less material does it need by volume?", a: "1/1000 as much - volume scales as k³, so a linear scale factor of 1/10 gives a volume ratio of (1/10)³ = 1/1000 compared to the full-size original." },
      { q: "Does 'scale factor' always mean the shapes are similar, or could they be different shapes entirely?", a: "Scale factor specifically applies to similar figures - shapes with identical proportions but different sizes (like two same-angle triangles). If the figures aren't similar (different shape, not just different size), the k² and k³ rules don't apply." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does color order matter - is comparing Color 1 to Color 2 the same as Color 2 to Color 1?", a: "No, the result is identical either way. Euclidean distance is symmetric, so swapping which hex code goes in which box doesn't change the calculated difference." },
      { q: "What's the difference between #FF0000 (red) and #00FF00 (green) using this calculator?", a: "About 360.6. Red is (255,0,0) and green is (0,255,0), so the distance is √(255² + 255² + 0²) ≈ 360.6 - close to the maximum, reflecting how visually distinct the two colors are." },
      { q: "Is this the same thing as a 'color contrast checker' for accessibility?", a: "No - contrast checkers for WCAG accessibility measure luminance contrast (important for text readability), while this tool measures raw RGB distance between two colors. A pair of colors can have a large RGB distance but still fail a luminance contrast test, or vice versa." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does a negative z-score mean?", a: "It means the value is below the mean - a z-score of -1.5 indicates the value sits 1.5 standard deviations below average, corresponding to a low percentile (around the 7th percentile)." },
      { q: "What's the z-score and percentile for a value exactly equal to the mean?", a: "The z-score is 0, and the percentile is 50% - a value equal to the mean sits at the exact center of a normal distribution, with half the data above and half below." },
      { q: "Is a 'standard score' the same thing as a 'z-score'?", a: "Yes - 'standard score' and 'z-score' are interchangeable terms for the same calculation: how many standard deviations a value is from the mean." },
    ],
    related: ["standard-deviation-calculator", "average-calculator", "percentage-calculator"],
  },
  {
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What probability corresponds to odds of 1 (even odds)?", a: "50%, since 1 ÷ (1 + 1) = 0.5 - 'even odds' and a 50% probability describe the same likelihood, just expressed in different formats." },
      { q: "Can probability be entered as a percentage instead of a decimal?", a: "Enter it as a decimal between 0 and 1 (like 0.25 for 25%) - the field expects the raw probability value, not a percentage sign, since the underlying formulas divide directly by that decimal value." },
      { q: "How do gambling odds like '3 to 1' relate to this converter's 'odds' format?", a: "'3 to 1' means the same as entering 3 as the odds value here (favorable-to-unfavorable ratio), which converts to a probability of 3 ÷ (1+3) = 75% using this tool's odds-to-probability formula." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What if I set the lower and upper bound to the same value?", a: "The probability comes out to essentially 0% - a continuous normal distribution assigns zero probability to hitting one exact point, only to falling within a range." },
      { q: "How do I find the probability of a value being above or below a single bound instead of between two?", a: "Set the lower bound to a very small number (like mean − 10×SD) to effectively capture everything below your upper bound, or set the upper bound very high to capture everything above your lower bound - this approximates a one-sided probability using the two-bound tool." },
      { q: "Does this work for distributions that aren't normal?", a: "No - this calculator specifically assumes a normal (bell-curve) distribution defined by its mean and standard deviation; skewed or non-normal data won't give accurate probabilities with this method." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What are the odds if there's no bonus ball at all?", a: "Set the bonus pool field to 0 - the calculator will then compute odds using only the main-pool combinations (n choose k), skipping the bonus multiplier entirely." },
      { q: "How much do the odds change if the main pool grows by just a few numbers?", a: "Substantially - combinations grow combinatorially, so raising a 5-number pick pool from 69 to 70 numbers increases the number of combinations by roughly 12%, making the jackpot noticeably harder to win." },
      { q: "Do smaller regional or scratch-off lotteries use the same odds formula?", a: "Yes - any lottery based on picking a fixed number of balls from a pool (with an optional separate bonus number) uses the same combinations formula shown here, just with different pool sizes and pick counts." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many total 5-card hands are possible from a 52-card deck?", a: "2,598,960 - calculated as 52 choose 5 = 52!/(5!×47!), which is the denominator used for every hand-ranking probability in the table." },
      { q: "What are the odds of getting a pair, the most common made hand?", a: "About 1 in 2.37 (roughly 42.3%) - one pair occurs in 1,098,240 of the 2,598,960 possible hands, making it by far the most frequently dealt hand ranking." },
      { q: "Does this table account for wild cards or jokers?", a: "No - these probabilities are for a standard 52-card deck with no wild cards or jokers; adding wild cards changes the combinatorics and would shift every probability in the table." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the cube root of a negative number, like -8?", a: "-2, since -2 × -2 × -2 = -8 - unlike square roots, cube roots of negative numbers are real, because multiplying three negative numbers together gives a negative result." },
      { q: "What is the square root of 0?", a: "0 - since 0 × 0 = 0, and it's the only number whose square root, square, and cube root are all equal to itself." },
      { q: "Is 'square root' the same as 'radical' or the '√ symbol'?", a: "Yes - '√', 'radical', and 'square root' all refer to the same operation of finding a number that, multiplied by itself, produces the value under the symbol." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the aspect ratio of a 1080×1920 vertical (portrait) video?", a: "9:16 - the same ratio as 16:9 landscape video but rotated, since GCD(1080, 1920) = 120, giving 1080÷120=9 and 1920÷120=16." },
      { q: "Can I find the new width instead of the new height when resizing?", a: "This calculator solves for a matching height given a new width; to go the other direction, swap the original width and height values you enter so the field effectively solves for the corresponding width instead." },
      { q: "What's the difference between aspect ratio and resolution?", a: "Resolution (like 1920×1080) gives the exact pixel dimensions of an image, while aspect ratio (like 16:9) only describes the proportional shape - many different resolutions (1920×1080, 1280×720, 3840×2160) all share the same 16:9 aspect ratio." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is the PPI of a typical smartphone screen, like 1080×2400 at 6.1 inches?", a: "About 442 PPI - the diagonal resolution is √(1080² + 2400²) ≈ 2632.6 pixels, divided by the 6.1-inch diagonal. That's why phone screens look noticeably sharper up close than a monitor with a much lower PPI." },
      { q: "Does a higher-resolution screen always have a higher PPI?", a: "Not necessarily - PPI depends on both resolution and physical size. A 4K (3840×2160) 43-inch TV has a lower PPI (~102) than a 1080p (1920×1080) 24-inch monitor (~92 is close, but a 15-inch 1080p laptop hits ~147 PPI) because the same pixel count is spread over more or less physical space." },
      { q: "Is PPI the same as 'Retina' display quality?", a: "Not exactly - Apple's 'Retina' marketing term refers to a PPI high enough that individual pixels become imperceptible at a typical viewing distance for that device (roughly 300 PPI for phones held close, lower for monitors viewed farther away), not a fixed PPI number across all screen types." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What DPI does a professional photo lab require for prints?", a: "Most labs want at least 300 DPI at the final print size, though many accept down to 200 DPI without a visible quality drop - check your specific lab's requirements, since some large-format printers use different thresholds." },
      { q: "Can I increase my image's DPI without adding real detail?", a: "You can resample (upscale) an image to report a higher DPI, but this doesn't add genuine pixel detail - it just spreads existing pixels over more print area or interpolates new ones, which can look softer or blurrier than a native high-resolution capture." },
      { q: "Is DPI for printing the same as PPI for screens?", a: "They're closely related but describe different outputs - PPI (pixels per inch) describes a digital image or screen's resolution, while DPI (dots per inch) technically refers to a printer's physical dot output. This calculator treats them as effectively interchangeable for figuring out print sharpness, which is standard practice outside of strict prepress work." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is 0 raised to the power of 0?", a: "By the most common mathematical convention, 0^0 is defined as 1, though it's a special edge case debated in some contexts - most calculators, including this one, follow the standard convention." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is log base 10 of 1000?", a: "3 - because 10³ = 1000. This calculator also shows the natural log (ln 1000 ≈ 6.9078) alongside it so you can compare bases at a glance." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does it mean if the dot product of two vectors is zero?", a: "The vectors are perpendicular (orthogonal) to each other - regardless of their individual magnitudes, a zero dot product means there's no component of one vector pointing along the other." },
      { q: "What's the magnitude of the vector (4, 5, 6)?", a: "About 8.775 - magnitude is √(x² + y² + z²), so √(4² + 5² + 6²) = √(16+25+36) = √77 ≈ 8.775, calculated for each vector separately by this tool." },
      { q: "Why is the cross product order-dependent (A×B vs B×A)?", a: "A×B and B×A point in exactly opposite directions (same magnitude, flipped sign) because the cross product is anti-commutative - swapping the order reverses which way the 'right-hand rule' points the resulting perpendicular vector." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Why isn't the great-circle distance the same as a straight line on a flat map?", a: "A flat map distorts distances because it projects a curved 3D surface onto a 2D plane - the true shortest path between two points on a sphere follows a great circle (part of a circle whose center is Earth's center), which usually looks curved, not straight, when drawn on a standard map projection." },
      { q: "Do I need to know the exact altitude or elevation of each point?", a: "No - the haversine formula only uses latitude and longitude and assumes both points sit on Earth's surface at sea level. Elevation differences are negligible compared to Earth's ~6,371 km radius for virtually all distance-estimation purposes." },
      { q: "What's the difference between this and a 'geodesic distance calculator'?", a: "They're closely related - 'geodesic distance' is the more general term for the shortest path on any curved surface, while 'haversine distance' specifically refers to this formula's spherical-Earth approximation. For most everyday distance checks, the two terms are used interchangeably." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can the Pythagorean theorem be used for non-right triangles?", a: "Not directly - a² + b² = c² only holds exactly when the triangle has a 90° angle. For any other triangle, you need the law of cosines instead, which adds a correction term (−2ab·cos(C)) to account for the non-right angle." },
      { q: "What is the hypotenuse of a right triangle with legs 6 and 8?", a: "10 - c = √(6² + 8²) = √(36 + 64) = √100 = 10, another well-known Pythagorean triple (a doubled 3-4-5)." },
      { q: "Does it matter which leg I label 'a' and which I label 'b'?", a: "No - a and b are interchangeable in the formula since addition is commutative (a² + b² gives the same result regardless of order). Only the hypotenuse c has a fixed role as the longest side, opposite the right angle." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can the distance formula give a negative result?", a: "No - distance is always zero or positive because the formula squares the differences (removing any negative sign) before taking a square root, which by convention returns the non-negative root." },
      { q: "Does this work for points in 3D space?", a: "This calculator handles 2D coordinate pairs only, but the same idea extends to 3D by adding a z-term: d = √((x₂-x₁)² + (y₂-y₁)² + (z₂-z₁)²)." },
      { q: "What if both points are the same?", a: "The distance is 0 - if (x1,y1) equals (x2,y2), then Δx and Δy are both 0, so d = √(0² + 0²) = 0, correctly indicating there's no separation between the points." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens if the three sides I enter can't form a real triangle?", a: "The calculator can't produce a valid result - by the triangle inequality, the sum of any two sides must be greater than the third side (e.g., 2, 3, and 10 can't form a triangle since 2+3 < 10). If your sides fail this check, double-check your measurements." },
      { q: "How do I find the largest angle in a triangle from its side lengths?", a: "The largest angle is always opposite the longest side - plug the longest side in as 'c' in the law of cosines rearrangement, cos(C) = (a² + b² − c²)/(2ab), then take the inverse cosine of the result." },
      { q: "Do the three angles always add up to 180°?", a: "Yes, for any triangle in standard flat (Euclidean) geometry - this is a useful check: after this calculator solves all three angles, they should sum to 180° (allowing for tiny rounding differences)." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What do N, K, n, and k each represent in plain terms?", a: "N is the total population (e.g., a full deck of 52 cards), K is how many 'success' items are in that population (e.g., 13 hearts), n is how many items you draw (your sample size), and k is how many successes you want among those drawn." },
      { q: "What happens if k is larger than either n or K?", a: "The probability is 0 - you can't draw more successes than you actually sampled (k > n) or more successes than exist in the population (k > K), so those combinations are mathematically impossible." },
      { q: "How is the mean of a hypergeometric distribution calculated?", a: "Mean = n × (K/N) - for the 5-card hand from a 52-card deck with 13 hearts, the expected number of hearts is 5 × (13/52) = 1.25, even though you can't actually draw a fractional number of hearts in any single hand." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What if I only know three sides and the height, not both parallel sides?", a: "This calculator needs both parallel sides (a and b) and the height to compute area - if you're missing one parallel side, you'll need another known angle or the slanted side lengths together with trigonometry to solve for it first." },
      { q: "How do I find the perimeter of a trapezoid?", a: "Add up all four sides: perimeter = a + b + c + d, where c and d are the two non-parallel (slanted) sides - enter them in the optional fields to get the perimeter alongside the area." },
      { q: "Is a trapezoid the same shape as what's called a 'trapezium'?", a: "It depends on the country - in American English, 'trapezoid' means a quadrilateral with exactly one pair of parallel sides, which is what British English calls a 'trapezium.' Confusingly, British English uses 'trapezoid' for a quadrilateral with no parallel sides at all." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the formula for the surface area of a rectangular prism?", a: "SA = 2(lw + lh + wh) - it adds up the areas of all six rectangular faces (two of each of the three unique face pairs) and doubles the sum since each face has an identical opposite face." },
      { q: "What's the surface area of a 5 × 4 × 3 box?", a: "94 - SA = 2×(5×4 + 5×3 + 4×3) = 2×(20 + 15 + 12) = 2×47 = 94 square units." },
      { q: "Do the units for volume and surface area differ?", a: "Yes - volume is measured in cubic units (like cm³ or ft³) since it multiplies three length dimensions together, while surface area is measured in square units (like cm² or ft²) since each face is a two-dimensional area." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does an 'undefined slope' mean and when does it happen?", a: "Slope is undefined when the two points share the same x-coordinate (a vertical line), because the slope formula's denominator (x2 − x1) becomes zero, and division by zero has no defined result." },
      { q: "How do I convert a slope value into an angle?", a: "Take the inverse tangent (arctan) of the slope: angle = arctan(m). A slope of 1 corresponds to a 45° angle, since tan(45°) = 1." },
      { q: "What's the slope between (1,2) and (4,8)?", a: "2 - m = (8-2)/(4-1) = 6/3 = 2, meaning y increases by 2 units for every 1 unit increase in x." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the difference between a sector's arc length and its chord length?", a: "Arc length follows the curved edge of the sector (r×θ in radians), while the chord is the straight line directly connecting the two endpoints of that arc - the chord is always shorter than the arc except in the limiting case of a very small angle." },
      { q: "How do I find the sector area if I only know the arc length, not the angle?", a: "First find the angle in radians by dividing arc length by radius (θ = s/r), then plug that into the area formula: area = 0.5 × r² × θ. This calculator does it directly from the angle, so convert first if arc length is all you have." },
      { q: "What's the area of a full 360° sector?", a: "It equals the full circle's area, πr² - a 360° sector is just the entire circle, since the two bounding radii coincide and the 'arc' wraps all the way around." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I convert a percentage grade into a ratio like '1:12'?", a: "Divide 100 by the percentage: for an 8.33% grade, 100/8.33 ≈ 12, giving a ratio of 1:12 (1 unit of rise for every 12 units of run) - a format commonly used for ramp and stair codes." },
      { q: "Can grade percentage exceed 100%?", a: "Yes - unlike a percentage of a whole, grade percentage is simply rise divided by run and has no upper cap. A grade over 100% means the rise is greater than the run, corresponding to an angle steeper than 45°." },
      { q: "Does a negative rise value make sense in this calculator?", a: "Yes - a negative rise represents a downhill slope (descending), and the calculator will return a negative grade percentage and angle, mirroring the same magnitude as the equivalent uphill grade but in the opposite direction." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How is the empirical formula different from the molecular formula?", a: "The empirical formula shows only the simplest whole-number ratio of atoms, while the molecular formula shows the actual number of atoms in one molecule - the molecular formula is always a whole-number multiple of the empirical formula (e.g., C₆H₁₂O₆ is 6× the empirical formula CH₂O)." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does the determinant (ad − bc) actually represent geometrically?", a: "It reflects whether the two lines have different slopes - a nonzero determinant means the lines intersect at exactly one point (a unique solution), while a zero determinant means the lines are parallel (either no solution or infinitely many, depending on the intercepts)." },
      { q: "Can this solve equations with fractions or decimals as coefficients?", a: "Yes - Cramer's rule works with any real number coefficients, including decimals and negative values, so equations like 2.5x + 1.2y = 7.4 work exactly like whole-number ones." },
      { q: "What's the solution to 2x + 3y = 16 and x − y = 2?", a: "x = 4.4, y = 2.4 - using Cramer's rule: determinant = (2)(-1) − (3)(1) = -5, x = ((16)(-1) − (3)(2))/(-5) = (-22)/(-5) = 4.4, y = ((2)(2) − (16)(1))/(-5) = (-12)/(-5) = 2.4." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can this solve equations where x has a fractional or decimal coefficient?", a: "Yes - a doesn't need to be a whole number. For example, 0.5x + 5 = 20 solves the same way: x = (20 − 5) / 0.5 = 30." },
      { q: "What's the solution to 3x + 5 = 20?", a: "x = 5 - using x = (c − b)/a: x = (20 − 5)/3 = 15/3 = 5." },
      { q: "Is a 'linear equation' the same as an 'algebraic equation'?", a: "Not quite - a linear equation specifically means the variable appears only to the first power (no x², √x, or 1/x terms), making its graph a straight line. 'Algebraic equation' is a broader term that includes linear, quadratic, and higher-degree equations." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What real-world things do eigenvalues and eigenvectors represent?", a: "They describe directions that a matrix transformation doesn't rotate, only stretches or shrinks - the eigenvector is that unchanged direction, and the eigenvalue is the stretch factor. This shows up in applications like vibration analysis, principal component analysis, and Google's PageRank algorithm." },
      { q: "What are the eigenvalues of the matrix [[2,1],[1,2]]?", a: "3 and 1 - trace = 2+2 = 4, determinant = (2×2)-(1×1) = 3, so λ² − 4λ + 3 = 0 factors to (λ−3)(λ−1) = 0, giving λ = 3 and λ = 1." },
      { q: "Can a 2x2 matrix have only one eigenvalue?", a: "Yes - this happens when the discriminant of the characteristic equation is zero (a 'repeated' or 'degenerate' eigenvalue), which occurs for matrices like [[2,1],[0,2]], where both roots of the quadratic coincide at the same value." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How is solving an inequality different from solving an equation?", a: "The steps are almost identical (isolate x by adding, subtracting, multiplying, or dividing on both sides), with one key exception: multiplying or dividing both sides by a negative number flips the inequality symbol's direction." },
      { q: "What's the solution to −2x + 3 ≤ 7?", a: "x ≥ −2 - subtract 3 from both sides to get −2x ≤ 4, then divide by −2 and flip the symbol (since you divided by a negative): x ≥ −2." },
      { q: "How do I graph the solution to an inequality on a number line?", a: "Use an open circle for < or > (the boundary value itself isn't included) and a filled circle for ≤ or ≥ (the boundary is included), then shade the number line in the direction the inequality points from that circle." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can Ksp be used to predict whether a precipitate will form?", a: "Yes, indirectly - by comparing the actual ion product (Q) in a solution to Ksp: if Q > Ksp, a precipitate forms because the solution is supersaturated; if Q < Ksp, more solid can still dissolve. This calculator finds Ksp itself, the saturation benchmark for that comparison." },
      { q: "Does a higher Ksp always mean a compound is more soluble?", a: "Only when comparing compounds with the same ion ratio (like two 1:1 salts) - because the Ksp formula raises concentrations to different powers depending on stoichiometry, comparing Ksp values directly across compounds with different x:y ratios can be misleading." },
      { q: "What is Ksp for a simple 1:1 salt like AgCl with molar solubility 1.3×10⁻⁵ mol/L?", a: "About 1.69×10⁻¹⁰ - for a 1:1 salt, [Ag⁺] = [Cl⁻] = s, so Ksp = s² = (1.3×10⁻⁵)² ≈ 1.69×10⁻¹⁰." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens to the pH exactly at the equivalence point if the volumes I enter are exactly matched in moles?", a: "The calculator returns pH 7, since equal moles of a strong acid and strong base neutralize completely - if your acid and base volumes/concentrations give exactly equal moles, you've hit the equivalence point." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much product can theoretically form once the limiting reagent is identified?", a: "Multiply the limiting reagent's moles by the mole ratio (from the balanced equation) between the limiting reagent and the product, then convert to grams using the product's molar mass - this calculator identifies which reactant limits the reaction, the first step toward that yield calculation." },
      { q: "What if both reactants give the exact same mol-to-coefficient ratio?", a: "Neither reagent is in excess - both are consumed completely at the same time, which is called a 'stoichiometric' mixture. In practice this is rare, since it requires the reactants to be measured in exactly the ratio the equation calls for." },
      { q: "Does the limiting reagent have to be the one with the smaller mass?", a: "Not necessarily - a reactant with a larger mass can still be limiting if it has a much higher molar mass or a larger required coefficient, since what matters is moles divided by the coefficient, not raw mass." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I find the half-life if I know the rate constant instead?", a: "Yes - use the same relationship rearranged: half-life = ln(2) / k. If a reaction has a rate constant k = 0.0231 per year, its half-life is ln(2) / 0.0231 ≈ 30 years." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many points can I miss and still get an A?", a: "It depends on the total points and where the A cutoff falls (90% on this calculator's default scale) - for a 100-point test, you can miss up to 10 points; for a 50-point test, up to 5 points, since the cutoff scales with the total." },
      { q: "What score do I need on the next section to raise a 78% to an 80%?", a: "This calculator computes a single grade from one earned/total pair, so to plan a target grade, treat your desired percentage as the goal and solve total × 0.80 = points needed - for example, on a 100-point assignment you'd need 80 points, 2 more than the 78 you have now." },
      { q: "Does a 0.5% difference actually change my letter grade?", a: "It can - since letter-grade cutoffs are hard boundaries (like 89.5% rounding to 90%), a fraction of a percentage point can be the difference between a B+ and an A-, which is why it's worth double-checking earned and total points for rounding errors before accepting a borderline grade." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens if I enter a weight as 0 for a category I haven't started yet?", a: "That category is excluded from the calculation entirely (multiplying by 0 contributes nothing to the numerator or denominator), so your current grade reflects only the categories with a nonzero weight - useful for tracking a running average as the semester progresses." },
      { q: "How much would the final exam need to be to get an overall A if I already know my homework and test scores?", a: "This calculator solves for the overall grade from all three categories at once, so to find a required final score, work backward: target = (desired overall × 100 − homework×weight − tests×weight) / final weight. For example, needing an 90 overall with 95×20 + 82×40 already locked in and a 40% final weight: (9000 − 1900 − 3280) / 40 = 95.5%." },
      { q: "Can I use this for more than three grade categories, like quizzes plus homework, tests, and a final?", a: "This version handles exactly three categories (homework, tests, final) - for a course with a quiz category too, combine quizzes into whichever existing category shares a similar weight, or compute a sub-average for quizzes first and treat that as one of the three inputs." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What GPA scale does this calculator use for each letter grade?", a: "The standard unweighted 4.0 scale: A=4.0, A-=3.7, B+=3.3, B=3.0, B-=2.7, C+=2.3, C=2.0, C-=1.7, D+=1.3, D=1.0, F=0.0 - the same scale most US colleges use for a base (non-honors) GPA." },
      { q: "How do I calculate my GPA for just 2 courses, one worth 3 credits at an A and one worth 4 credits at a B?", a: "Quality points: (4.0×3) + (3.0×4) = 12 + 12 = 24. Total credits: 3 + 4 = 7. GPA = 24 ÷ 7 ≈ 3.43." },
      { q: "Does a Pass/Fail or Withdraw grade affect my GPA in this calculator?", a: "This calculator only accepts standard letter grades (A through F) with defined grade points, so pass/fail or withdrawal courses - which most schools exclude from GPA math entirely - should simply be left out by setting their credit hours to 0." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does making one extra payment change the whole schedule?", a: "Yes - an extra payment applied to principal reduces the balance that all future interest is calculated on, so every remaining line of the schedule shifts: less interest and more principal in each subsequent payment, and the loan finishes earlier than the original term." },
      { q: "How much interest do I pay in total on a $250,000 loan at 6% over 30 years?", a: "The monthly payment is about $1,499, and over 360 payments that totals roughly $539,600 - meaning about $289,600 of it is interest, which the schedule breaks out payment by payment." },
      { q: "Is an amortization schedule the same as a loan payment calculator?", a: "Related but not identical - a basic loan payment calculator just gives you the single monthly payment amount, while an amortization schedule shows that same payment split into principal and interest for every period, plus the running balance." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How is the draw period payment calculated?", a: "It's interest-only: the amount drawn multiplied by the periodic interest rate (annual rate divided by 12). On a $30,000 balance at 8%, the monthly draw-period payment is about $30,000 × (0.08/12) = $200, with none of it reducing principal." },
      { q: "Why does my payment jump so much when repayment starts?", a: "During the draw period you're only covering interest, so the full drawn balance is still owed. Once repayment begins, that same balance has to fully amortize (principal plus interest) over the shorter repayment period, which produces a much larger monthly payment than the interest-only draw payment." },
      { q: "Is a HELOC calculator the same as a home equity loan calculator?", a: "No - a home equity loan is a lump sum with fixed payments from day one, calculated like a standard amortizing loan. A HELOC is a revolving line with a distinct interest-only draw period followed by a separate amortizing repayment period, which is what this calculator is built to model." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How does the interest rate affect how much house I can afford?", a: "A higher rate increases the monthly payment for the same loan amount, which eats into the 28%/36% payment limits faster - so at a higher rate, the maximum loan (and therefore home price) the calculator returns is lower for the same income and debt." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I figure out my salary if I don't work exactly 52 weeks a year?", a: "Reduce the weeks-per-year figure to match your actual working weeks - for example, if you take 2 unpaid weeks off, enter 50 instead of 52. At $25/hour, 40 hours/week: 50 weeks gives $50,000/year versus $52,000/year at the full 52 weeks." },
      { q: "Does part-time work convert the same way as full-time?", a: "Yes, the same multiplication applies regardless of hours - it's just hourly rate × hours per week × weeks per year. A part-time job at $20/hour for 20 hours/week, 52 weeks/year, comes out to $20,800/year, using the exact same formula as a full-time calculation." },
      { q: "Is 'hourly wage to yearly income' the same calculation as this tool?", a: "Yes - that phrasing describes exactly what this calculator does: enter an hourly rate along with weekly hours and weeks worked, and it converts that into the equivalent annual figure." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate an 18% tip on a $64 bill?", a: "Multiply the bill by 0.18: $64 × 0.18 = $11.52 tip, for a total of $75.52 - this calculator does that multiplication automatically once you enter the bill and tip percentage." },
      { q: "Does splitting the bill change the tip percentage each person pays?", a: "No - splitting just divides the same total tip and bill evenly across the number of people, so everyone effectively contributes the same tip percentage; it doesn't change the overall 15-20% (or whatever rate you set) applied to the full bill." },
      { q: "Is a 'bill splitter' the same as a tip calculator?", a: "They overlap - a pure bill splitter only divides a total among people, while a tip calculator like this one also computes the tip amount first and then splits the combined bill-plus-tip total evenly." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can this calculator solve for the number of periods or the interest rate instead?", a: "This version solves for present value, future value, or payment given the other inputs - it's not built to solve for rate or number of periods, which typically require iterative (trial-and-error) methods rather than a direct formula." },
      { q: "What happens if I leave PV at zero and solve for FV?", a: "With PV set to 0, the future value comes entirely from the payment stream compounding over time - for example, PMT of -200 per month at a 0.5% monthly rate for 120 periods, with PV of 0, yields an FV of roughly $32,700, matching a standard savings annuity calculation." },
      { q: "Is this the same as an 'annuity calculator'?", a: "Very similar - an annuity calculator usually solves for one of these same values (future value, payment, or present value) for a stream of equal periodic payments, which is exactly the calculation this TVM solver performs." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can IRR and NPV disagree about which project is better?", a: "Yes - when comparing projects of different sizes or cash flow timing, NPV and IRR can rank them differently. A smaller project might show a higher IRR (percentage return) while a larger project shows a higher NPV (total dollar value created); most finance guidance favors NPV in that conflict." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What if I don't have a 'housing' or 'transportation' cost some months?", a: "Enter 0 for any category that doesn't apply to you - the calculator just sums whatever categories have a value, so leaving one at zero simply excludes it from your total spending and the needs/wants comparison." },
      { q: "How is the 20% savings portion calculated if I don't enter a separate savings amount?", a: "The calculator infers it: it subtracts your total entered expenses from your income, and whatever's left over is treated as your effective savings/leftover rate to compare against the 20% target - it isn't a category you fill in directly." },
      { q: "Is a 50/30/20 budget the same as a zero-based budget?", a: "No - the 50/30/20 rule sets broad percentage targets across three buckets (needs, wants, savings) without assigning every dollar a specific job. A zero-based budget assigns every dollar of income to a specific category until income minus allocations equals zero, which is a more granular approach than this calculator models." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much does $10,000 grow to in 20 years at 6% compounded annually?", a: "Using A = P(1 + r/n)^(nt) with P=$10,000, r=0.06, n=1, t=20: A = $10,000 × 1.06^20 ≈ $32,071 - roughly $22,071 in interest earned on top of the original principal." },
      { q: "Does this calculator account for regular contributions, or just a one-time lump sum?", a: "This tool models a single lump-sum principal growing on its own - it doesn't add recurring monthly deposits. For growth that includes ongoing contributions, use a calculator built for regular deposits, such as an investment or savings calculator." },
      { q: "Is 'continuous compounding' the same as entering a very high compounding frequency?", a: "Not exactly the same, but a close approximation - continuous compounding uses the formula A = Pe^(rt) and represents the theoretical limit as compounding frequency approaches infinity. Entering a very large number like 365 (daily) or higher for compounds per year gets you very close to that continuous-compounding result." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is 24% APR on a credit card, compounded daily, as an APY?", a: "About 27.11% - (1 + 0.24/365)^365 − 1 ≈ 0.2711, illustrating why credit card APY can run noticeably higher than the quoted APR once daily compounding is factored in." },
      { q: "If compounding is annual, does APY equal APR?", a: "Yes - with compounds per year set to 1, the formula (1 + APR/1)^1 − 1 simplifies to exactly APR, since there's no intra-year compounding to create a gap between the nominal and effective rates." },
      { q: "Is 'effective interest rate' the same thing as APY?", a: "Yes - APY, EAR (effective annual rate), and effective interest rate all refer to the same concept: the true annualized return or cost once compounding within the year is accounted for, which is exactly what this calculator computes from a nominal APR." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I find the discount percentage if I know both the original and sale price?", a: "Subtract the sale price from the original price to get the savings amount, divide that by the original price, then multiply by 100. An item marked down from $120 to $90 saved $30, and 30/120 × 100 = 25% off." },
      { q: "Does a coupon for a fixed dollar amount work the same way as a percentage discount here?", a: "Not directly - this calculator is built for percentage-off discounts. For a flat dollar-amount coupon (like $10 off), just subtract that fixed amount from the price yourself rather than entering it as a percentage, since a $10 coupon represents a different percentage off depending on the item's price." },
      { q: "Is 'percent off calculator' the same tool as a discount calculator?", a: "Yes - both describe the same calculation: applying a percentage reduction to an original price to find the sale price and the amount saved, which is exactly what this tool does." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "If I want a 50% markup instead of a 50% margin, do I get the same selling price?", a: "No - a 50% markup means selling price = cost × 1.50, while a 50% margin means selling price = cost ÷ (1 − 0.50) = cost × 2. On a $40 cost, a 50% markup gives a $60 price, but a 50% margin gives an $80 price, since margin is measured against the selling price, not the cost." },
      { q: "What margin do I need to double my cost as the selling price?", a: "A 50% margin. Selling price = cost ÷ (1 − margin), and setting that equal to 2 × cost means (1 − margin) = 0.5, so margin = 50% - the same margin percentage that maps to a 100% markup." },
      { q: "Can this calculator be used to price a service instead of a product?", a: "Yes - the math is identical whether 'cost' represents your material cost for a product or your total cost to deliver a service (labor, overhead, etc.); enter your total cost and target margin and the formula works the same way either way." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens if I set a payment lower than the interest that accrues each month?", a: "The balance won't shrink and can grow instead, since the fixed payment isn't covering the monthly interest charge - this calculator requires a payment above the interest-only amount to produce a finite payoff time; otherwise the debt would never be paid off." },
      { q: "How is the payoff time actually calculated?", a: "Each month the calculator applies interest to the current balance, subtracts your fixed payment, and repeats until the balance reaches zero, counting the number of months it takes - the same iterative process used in an amortization schedule, just tracked until payoff rather than for a fixed term." },
      { q: "How much interest would I pay off a $15,000 balance at 15% with $400/month payments?", a: "It takes about 47 months to pay off, with roughly $3,700 in total interest paid over that period - increasing the monthly payment amount would shorten both the payoff time and the total interest." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does rent count as debt in the DTI calculation if I don't own a home yet?", a: "For a mortgage application, yes - rent (or your prospective mortgage payment) is typically included as part of housing costs in the DTI calculation, since lenders want to see your total recurring housing-plus-debt burden relative to income, not just non-housing debts." },
      { q: "Front-end DTI versus back-end DTI - what's the difference?", a: "Front-end DTI includes only housing costs (mortgage, taxes, insurance) divided by gross income. Back-end DTI includes housing costs plus all other recurring debt payments divided by gross income - this calculator computes the back-end version, using whatever total monthly debt figure you enter." },
      { q: "If my gross monthly income is $5,000 and I want a DTI under 36%, what's my max total debt payment?", a: "36% of $5,000 is $1,800 - so keeping all recurring monthly debt payments (including housing) at or below $1,800 would keep your DTI at or under that commonly cited threshold." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the 'minimum payment floor' field actually for?", a: "Card issuers typically require the minimum payment to be the greater of a percentage of the balance or a flat dollar floor (often around $25-35) - this ensures the calculated minimum payment never drops below that floor amount even as the balance shrinks and the percentage-based portion gets very small." },
      { q: "Why does the required minimum payment decrease every month?", a: "Because it's calculated as a percentage of the current balance (plus interest), and the balance shrinks slightly each month as you pay it down - a smaller balance produces a smaller required percentage-based payment, which is exactly why minimum-payment payoffs stretch out for so long." },
      { q: "Is this the same as the Debt Payoff Calculator?", a: "No - the Debt Payoff Calculator assumes a fixed payment amount every month until the balance is gone. This calculator models a declining minimum payment that shrinks as the balance shrinks, which is how real credit card minimums typically work and why payoff times run much longer." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does the employer match count toward the IRS annual 401(k) contribution limit?", a: "Employer matching contributions are generally not counted against your personal elective-deferral limit, though they do count toward a separate, higher combined limit for total annual additions to the account - this calculator only models the match amount itself, not IRS limit rules." },
      { q: "On an $80,000 salary contributing 6% with a 100% match up to 3%, how much goes in annually before growth?", a: "Your contribution is 6% of $80,000 = $4,800; the employer match caps at 3% of salary = $2,400 (100% of your contribution up to that 3% limit), for a combined $7,200 added to the account that year before any investment growth." },
      { q: "Why would increasing contribution percentage beyond the match limit still matter for the projection?", a: "Even once you've captured the full employer match, additional personal contributions keep compounding for the same number of years at the assumed return rate, so contributing more (subject to IRS limits) still meaningfully increases the projected balance at retirement - the match limit only affects how much extra money the employer adds, not how much you're allowed to contribute yourself." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does a sloped or uneven bed need extra mulch beyond the basic calculation?", a: "Yes - this calculator assumes a uniform depth across a flat area. For sloped or uneven beds, measure depth at a few different points and average them, or split the bed into flatter sections and calculate each separately, since a single average depth can under-order material for the low spots." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much gravel do I need for a 12×24 ft driveway at 6 inches deep?", a: "12×24 ft is 288 sq ft. At 6 inches deep that's 144 cubic feet, or about 5.33 cubic yards before waste. With a 10% waste allowance, order about 5.87 cubic yards, or roughly 8.21 tons at the typical 1.4 tons-per-cubic-yard density." },
      { q: "Does a driveway need the same gravel depth as a walkway?", a: "No - walkways and light foot-traffic paths typically only need 2-3 inches of gravel, while driveways supporting vehicle weight need 4-6 inches, often over a separately compacted sub-base. Enter the depth appropriate to your project rather than a single universal number." },
      { q: "Is a 'gravel calculator' the same as a 'crushed stone calculator'?", a: "Functionally yes - both estimate volume and tonnage the same way, since gravel and crushed stone are priced and delivered by the cubic yard or ton. The difference is physical: gravel is naturally rounded while crushed stone is mechanically fractured, which affects how well it compacts, not the math used to size the order." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many boxes do I need for a 12×15 ft room with 20 sq ft coverage per box?", a: "12×15 ft is 180 sq ft. With a 10% waste allowance that's 198 sq ft of material needed, which at 20 sq ft per box rounds up to 10 boxes." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many sheets do I need for a 12×20 ft room with 8 ft ceilings?", a: "Wall area is the perimeter times the ceiling height: (12+20)×2×8 = 512 sq ft. With a 10% waste allowance that's 563.2 sq ft, which at 32 sq ft per 4×8 sheet rounds up to 18 sheets." },
      { q: "Should I subtract door and window openings from the wall area?", a: "For average-size doors and windows, most estimators skip subtracting them since the 10% waste allowance already covers the material lost cutting around framing. For unusually large openings, like sliding doors or picture windows, subtract that area from your wall total first." },
      { q: "Does sheet count change between 1/2 inch and 5/8 inch drywall?", a: "No - sheet count is based on square footage of coverage, not thickness, so the calculation is the same either way. What changes is weight and, in some cases, code requirements: 5/8 inch fire-rated drywall is often required for garages and shared walls between units." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many 6×6 tiles do I need for a 10×12 ft bathroom?", a: "10×12 ft is 120 sq ft. With a 1/8 inch grout line, each tile covers about 0.26 sq ft (6.125×6.125÷144). With a 10% waste allowance, 120 sq ft needs about 132 sq ft of coverage, which comes out to roughly 507 tiles." },
      { q: "Should I round the tile count up or use the decimal number the calculator gives?", a: "Always round up to the next whole tile - partial tiles aren't sold, and the waste allowance already accounts for the extra cut pieces this rounding produces plus additional cuts made on-site." },
      { q: "Should I use the tile calculator or the flooring calculator for a tiled floor?", a: "Use this tile calculator when you know your exact tile dimensions and grout line width, since it accounts for grout spacing between individual pieces. The general flooring calculator is better suited to plank or box-based flooring that's priced and sold per box of a known square footage." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many squares do I need for a 2000 sq ft footprint with a 4/12 pitch?", a: "A 4/12 pitch gives a multiplier of about 1.054, so 2000 sq ft becomes roughly 2108 sq ft of actual roof area. With a 10% waste allowance that's about 2319 sq ft, or 24 squares after rounding up." },
      { q: "Does a steeper roof always need proportionally more waste allowance too?", a: "This calculator applies a flat waste percentage regardless of pitch, but in practice very steep roofs (above roughly 9/12) or roofs with many hips and valleys need a higher waste allowance than a simple roof, since more shingles get cut at odd angles - increase the waste input above 10% for complex, steep rooflines." },
      { q: "What's the difference between 'roofing squares' and plain square footage?", a: "Square footage measures flat area; a roofing square is a sales unit equal to 100 sq ft of the actual sloped roof surface. Because pitch increases the sloped area beyond the footprint, a 1500 sq ft footprint isn't 15 squares of shingles - it's more, which is exactly what the pitch multiplier in this calculator corrects for." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate square footage for a room measured in meters?", a: "A 4×5 meter room converts to about 13.12×16.40 ft, giving roughly 215.3 sq ft - the same as multiplying 20 sq meters by 10.764. Select 'Meters' as the unit and the calculator handles the conversion for you." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many posts and panels do I need for 150 ft of fence with 6 ft panels?", a: "150 ÷ 6 = 25 panels exactly, which needs 26 posts - one more than the panel count to close both ends of the run." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many bags do I need for R-38 in a 1000 sq ft attic using cellulose at 3.4 R-value per inch?", a: "R-38 at 3.4 R-value per inch requires about 11.2 inches of depth. Over 1000 sq ft that's about 931 cubic feet, or roughly 33 bags at a 30 cu ft yield per bag, including a 5% waste allowance." },
      { q: "Does loose-fill insulation stay at the depth I install it at?", a: "No - loose-fill (blown-in) insulation settles over time, losing some of its installed depth and R-value. Manufacturers publish a higher 'initial installed thickness' than the long-term 'settled thickness' specifically to compensate, so install to the initial thickness figure on the product's coverage chart, not the settled one." },
      { q: "Does this calculator work for batt insulation too, or just blown-in?", a: "This calculator is built for blown-in/loose-fill insulation, which is sold by bag yield in cubic feet. Batt insulation is sold by R-value and square footage per package instead, so for batts compare your attic's square footage directly to the batt's coverage rating rather than using bag yield." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many BTUs for a 450 sq ft sunny living room with 4 typical occupants?", a: "Baseline is 450 × 20 = 9,000 BTU/h. Sunny exposure adds 10% (9,900 BTU/h), and 2 occupants beyond the standard 2 add 2 × 600 = 1,200 BTU/h, bringing the total to about 11,100 BTU/h, or roughly 0.93 tons." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many board feet for 15 boards of nominal 2×4×10 ft lumber?", a: "Using actual dimensions of 1.5×3.5 inches: 1.5 × 3.5 × 10 ÷ 12 = 4.375 board feet per board. For 15 boards that's about 65.6 total board feet." },
      { q: "Does board length affect board feet the same way width and thickness do?", a: "Yes, all three dimensions contribute proportionally - board feet is thickness × width × length ÷ 12, so doubling any one of the three (with the others held constant) doubles the board feet, whether that's a longer board, a wider board, or a thicker one." },
      { q: "How is a board foot different from a linear foot of lumber?", a: "A linear foot only measures length, ignoring width and thickness, so it can't compare boards of different sizes fairly. A board foot is a volume measurement (12×12×1 inch), which is why lumber of varying widths and thicknesses is priced by board feet rather than by linear foot." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many 8×16 inch pavers do I need for a 150 sq ft patio?", a: "Each 8×16 inch paver covers about 0.89 sq ft (8×16÷144). With a 10% waste allowance, 150 sq ft needs about 165 sq ft of coverage, which comes out to roughly 186 pavers." },
      { q: "Does paver shape or pattern change how much waste allowance I should use?", a: "Yes - a simple running-bond pattern with square or rectangular pavers typically needs only the standard 10%, but herringbone or basket-weave patterns, or borders that require many angled cuts, can need 15% or more since more pieces get trimmed and discarded." },
      { q: "How is a paver calculator different from a tile calculator?", a: "The math is similar - both divide a waste-adjusted area by each unit's coverage - but pavers are laid outdoors over a compacted gravel and sand base rather than adhered with grout lines like tile, so this calculator doesn't add a grout-line spacing factor the way the tile calculator does." },
    ],
    related: ["gravel-calculator", "concrete-calculator", "unit-length-converter"],
  },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How is BMR different from calories burned per day?", a: "BMR only counts the energy your body needs at total rest to keep organs running - it doesn't include walking, exercise, or even digestion. Your actual daily burn (TDEE) is BMR multiplied by an activity factor, which is usually 1.4 to 1.9 times higher than BMR alone." },
      { q: "What's an example BMR calculation?", a: "For a 25-year-old woman, 5'6\" (66 in), 140 lb, the Mifflin-St Jeor formula gives roughly 1,410 calories per day. That number represents calories burned lying still for 24 hours, before adding any movement." },
      { q: "Is BMR the same as 'resting metabolic rate' (RMR)?", a: "They're closely related but not identical - BMR is measured under strict lab conditions (fasted, fully rested, controlled temperature), while RMR is a slightly less strict measurement that's typically 10-20% higher. Most online calculators, including this one, estimate BMR-like values using formulas rather than direct measurement, so the term is often used loosely." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example BSA calculation?", a: "For someone 180 cm tall weighing 80 kg: BSA = √((180 × 80) ÷ 3600) = √4 = 2.0 m². That's on the higher end of the typical adult range." },
      { q: "How does BSA differ from BMI?", a: "BMI (weight ÷ height²) is a screening tool for weight status relative to height, while BSA estimates total skin surface area and is used mainly for medical dosing and physiological measurements like cardiac index - they answer different questions and aren't interchangeable." },
      { q: "Does the Mosteller formula work the same for children as adults?", a: "Yes - the Mosteller formula uses the same equation regardless of age, since it's based purely on height and weight rather than age-specific constants. This makes it a common choice in pediatric dosing calculations as well as adult ones." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many calories should I eat to gain weight?", a: "A surplus of about 300-500 calories per day above maintenance is a common target for gradual, mostly lean weight gain - eating far above that tends to add more fat than muscle even with training." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example body fat calculation?", a: "For a man 5'10\" (70 in) with a 15-inch neck and 34-inch waist, the Navy formula estimates roughly 15% body fat - a range generally considered fit/athletic." },
      { q: "Why does the formula need hip measurement for women but not men?", a: "The Navy method uses a different equation for each sex - women's body fat distribution is more influenced by hip circumference, so the formula for women adds a hip measurement term that isn't in the men's equation, which uses only neck and waist." },
      { q: "What counts as a healthy body fat percentage?", a: "General ranges are roughly 10-20% for men and 18-28% for women, though healthy ranges shift with age and athletic goals. These are broad guidelines, not medical thresholds - a doctor or sports medicine professional can interpret your number in context." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's a balanced macro split if I don't have a specific goal?", a: "A common general-purpose starting point is roughly 30% protein, 30% fat, 40% carbs, though this calculator lets you enter any percentages that sum to 100% so you can adjust for your own goals or dietary preferences." },
      { q: "What happens if my percentages don't add up to 100%?", a: "The math only works cleanly when protein, fat, and carb percentages sum to 100% of your daily calories - if they don't, the resulting gram amounts won't actually account for your full calorie target, so double-check the three inputs add up before relying on the results." },
      { q: "Why is fat calculated differently from protein and carbs?", a: "Fat provides 9 calories per gram, more than double the 4 calories per gram from protein or carbs - so the same percentage of daily calories converts to fewer grams of fat than of protein or carbs. At 2,000 calories, 30% fat is about 67g, while 30% protein is about 150g." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example one-rep max calculation?", a: "Squatting 225 lb for 8 reps: 1RM = 225 × (1 + 8 ÷ 30) ≈ 285 lb using the Epley formula." },
      { q: "How does the Epley formula compare to other 1RM formulas like Brzycki?", a: "Different formulas (Epley, Brzycki, Lombardi) give slightly different estimates for the same weight and reps, usually within a few pounds of each other - Epley tends to estimate a bit higher at higher rep counts, but all are approximations rather than exact predictions." },
      { q: "Can I use my estimated 1RM to plan a workout program?", a: "Yes - many strength programs prescribe training weights as a percentage of your 1RM (e.g., 5 sets at 75% of 1RM). Multiply your estimated max by the target percentage to find the weight to load - just re-test periodically since your true max changes as you train." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example of calculating heart rate zones?", a: "A 40-year-old has an estimated max heart rate of 220 - 40 = 180 bpm. Their moderate-intensity zone (50-70%) would be roughly 90-126 bpm, and their vigorous zone (70-85%) would be roughly 126-153 bpm." },
      { q: "Is the fat-burning zone actually the best zone for weight loss?", a: "Not necessarily - while a lower-intensity zone burns a higher percentage of calories from fat, higher-intensity zones burn more total calories per minute, which often results in more overall fat loss even though a smaller share of those calories comes from fat directly." },
      { q: "Why do heart rate zone calculators sometimes give different max heart rate numbers?", a: "The 220-minus-age formula is the most common estimate, but other formulas (like Tanaka's 208 - 0.7×age) exist and can differ by several beats per minute. All are population averages - a supervised fitness test or wearable's measured max is more accurate for any individual." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example ideal weight calculation?", a: "For a woman who is 5'4\" (64 in), the Devine formula gives 45.5 kg + (2.3 kg × 4 inches over 5 feet) = 54.7 kg, or about 121 lb." },
      { q: "Should ideal weight match the middle of a healthy BMI range?", a: "Not always - Devine-formula results and BMI-based healthy-weight ranges are calculated differently and can diverge, especially at taller or shorter heights, since Devine grows linearly with height while BMI ranges grow with height squared." },
      { q: "Does this account for body frame size (small, medium, large)?", a: "No - the Devine formula used here is based only on height and gender, not wrist circumference or frame size. Some other ideal-weight methods add a frame-size adjustment, which can shift the estimate up or down by several pounds for the same height." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example bra size calculation?", a: "If your underbust measures 30 inches and your bust measures 34 inches, the band size rounds to 32 and the 4-inch bust-to-underbust difference corresponds to a D cup, giving an estimated size of 32D." },
      { q: "Is a 'sister size' the same as my calculated size?", a: "A sister size is a different band/cup combination that has a similar cup volume to your calculated size - for example, 32D and 34C hold roughly the same cup volume on different bands. If your calculated size doesn't fit, its sister size is often worth trying." },
      { q: "Does band size get rounded up or down?", a: "Band size is typically rounded to the nearest even number in US sizing - an underbust measurement of 29 inches rounds to a 30 band, and 31 inches also rounds to 30, since bra bands are only manufactured in even-number increments." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I convert a mile pace to a kilometer pace?", a: "Multiply your per-mile pace by 0.621 (since 1 km = 0.621 miles) - a 9:00/mile pace works out to about 5:36/km." },
      { q: "What's an example pace calculation for a marathon?", a: "Finishing a marathon (26.2 miles) in 4 hours means an average pace of 240 minutes ÷ 26.2 miles ≈ 9:10 per mile." },
      { q: "Why is my race pace usually different from my training pace?", a: "Race-day factors like taper rest, crowd energy, and adrenaline often let runners hold a faster pace than typical training runs, while conditions like heat or hills can slow it down - this calculator shows the math between time, distance, and pace, but doesn't predict race-day performance itself." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I find the time for a trip if I know distance and speed?", a: "Time = distance ÷ speed. Driving 150 miles at 50 mph takes 150 ÷ 50 = 3 hours." },
      { q: "Why does my answer look wrong when I enter time in minutes instead of hours?", a: "This calculator treats the time field as a plain number in whatever unit you intend, so if your speed is in mph but you enter time in minutes, the math is internally consistent but the units don't match - convert minutes to hours (divide by 60) first, or convert your speed to per-minute units instead." },
      { q: "Is this the same as an average speed calculator?", a: "Yes - 'average speed calculator' and 'speed distance time calculator' both refer to solving speed = distance ÷ time (or one of its rearrangements), which is exactly what this tool does when you select speed as the value to solve for." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate the maximum height of a projectile?", a: "Max height = (v × sin(angle))² / (2 × g). For a launch at 20 m/s and 45° with g = 9.81: (20×sin45°)² / (2×9.81) = (14.14)² / 19.62 ≈ 10.19 m." },
      { q: "What happens to the range if I double the launch velocity?", a: "The range quadruples - since range is proportional to velocity squared (range = v²×sin(2×angle)/g), doubling v multiplies the range by 2² = 4, holding angle and gravity constant." },
      { q: "Can I use this for a projectile launched from a height, like off a cliff?", a: "No - this calculator assumes launch and landing occur at the same height (ground level), which simplifies the flight-time formula. A projectile launched from an elevated point needs an additional term accounting for the extra fall distance, which this tool doesn't include." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What if the two objects have equal mass in an elastic collision?", a: "They simply exchange velocities - the elastic collision formulas simplify so that v1f = v2 and v2f = v1 when m1 = m2, a classic result you can see with equal-mass billiard balls or Newton's cradle." },
      { q: "How do I find the final velocity of a perfectly inelastic collision?", a: "v_final = (m1×v1 + m2×v2) / (m1+m2), since the objects stick together and move at one shared velocity. For a 2 kg object at 5 m/s hitting a stationary 3 kg object: (2×5 + 3×0)/(2+3) = 10/5 = 2 m/s." },
      { q: "Does this calculator handle collisions in two dimensions, like an angled impact?", a: "No - this calculator only solves 1D (head-on) collisions along a single line of motion. A 2D collision requires separately conserving momentum along two perpendicular axes, which needs the objects' angles as additional inputs." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate resistance if I know voltage and current?", a: "R = V / I. For a circuit with 12 volts and 3 amps of current: R = 12 / 3 = 4 ohms." },
      { q: "What is the voltage across a 5-ohm resistor carrying 4 amps?", a: "20 volts - using V = I × R = 4 × 5 = 20 V." },
      { q: "Can I enter voltage and power instead of voltage and current?", a: "No - this calculator solves specifically from two of voltage, current, and resistance. If you have voltage and power instead, first find current with I = P/V, then enter voltage and that current to get resistance and confirm power." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I solve a right triangle if I only know one side and one angle?", a: "No - this calculator requires two known sides (any two of the two legs and the hypotenuse) to apply the Pythagorean theorem. If you only have one side and one angle, you'd need trigonometric ratios (sine, cosine, tangent) instead, which this tool doesn't take as direct inputs." },
      { q: "How do I check that three side lengths actually form a valid right triangle?", a: "Verify that the square of the longest side equals the sum of squares of the other two (a² + b² = c²). For sides 6, 8, and 10: 6² + 8² = 36 + 64 = 100 = 10², confirming a valid right triangle." },
      { q: "What's the difference between this and a general (non-right) triangle calculator?", a: "This tool relies on the Pythagorean theorem, which only holds when one angle is exactly 90° - a general triangle (acute or obtuse) needs the Law of Sines or Law of Cosines instead, since side-angle relationships aren't as simple without a right angle." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example due date calculation from LMP?", a: "If the first day of your last period was January 1st, adding 280 days (Naegele's rule) puts your estimated due date around October 8th." },
      { q: "How is a due date calculated from a known conception date instead of LMP?", a: "From a known conception date, add 266 days (38 weeks) rather than 280 days, since conception typically occurs about two weeks after the start of the last period - this shifts the estimate compared to the LMP method by roughly that same two-week gap." },
      { q: "Can this due date change later in pregnancy?", a: "Yes - an early ultrasound (typically in the first trimester) is generally considered more accurate than an LMP-based estimate and may shift your official due date by several days if your cycle wasn't exactly 28 days or ovulation timing differed from the standard assumption." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example ovulation calculation?", a: "If your last period started on the 1st and your average cycle is 30 days, ovulation is estimated around day 16 (30 - 14), meaning roughly the 16th of that cycle." },
      { q: "How is the fertile window calculated from the ovulation date?", a: "It's estimated as the 5 days leading up to ovulation plus the ovulation day itself - for an ovulation date of the 16th, the fertile window would run roughly from the 11th through the 16th." },
      { q: "Is 'ovulation calculator' the same thing as a 'fertility calculator'?", a: "They usually refer to the same underlying calculation - estimating ovulation timing and the surrounding fertile window from cycle data - though some fertility calculators also factor in additional inputs like basal body temperature or hormone test results for a more personalized estimate." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Are the start and end dates both counted as business days?", a: "Yes, if they fall on a weekday - the calculator counts every weekday from the start date through the end date inclusive. For example, Monday to Friday of the same week counts as 5 business days, not 4." },
      { q: "How many business days are in a typical 2-week (10 business day) sprint?", a: "Two full Monday-Friday weeks give exactly 10 business days, assuming no holidays fall in that span - if either end date lands on a weekend, the count will be lower since weekend days are excluded." },
      { q: "Is this the same as a 'working days calculator' or 'weekday counter'?", a: "Yes - 'business days,' 'working days,' and 'weekdays between dates' all refer to the same Monday-Friday count this tool produces; only the terminology differs by region and industry." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate duration for a night shift, like 11 PM to 7 AM?", a: "Enter 23:00 as the start and 07:00 as the end - since the end hour is numerically smaller, the calculator treats it as crossing midnight and returns 8 hours, the correct overnight shift length." },
      { q: "What if the start and end time are identical?", a: "The calculator treats an identical start and end time as a full 24-hour span (crossing midnight back to the same clock time) rather than zero, since it always measures forward from start to end." },
      { q: "Is this the same as an 'elapsed time calculator'?", a: "Yes - both terms describe finding the span between two clock times. This tool works specifically with hours and minutes on a 24-hour clock rather than full calendar dates." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I set an alarm for a time that's technically tomorrow, like 1:00 AM?", a: "Yes - if the time you set has already passed today, the alarm automatically targets that time tomorrow instead, so setting 1:00 AM at 3:00 PM today will ring the following night." },
      { q: "Will the volume or sound be loud enough to wake me up if I'm asleep?", a: "It plays through your device's normal audio output at whatever volume your system is set to, so it's best suited for staying alert during the day rather than relied on as a guaranteed wake-up alarm for deep sleep." },
      { q: "How is this different from my phone's built-in alarm app?", a: "A phone's native alarm app keeps working even if the phone is locked or the browser is closed, while this browser-based alarm only rings while its tab stays open - use it for quick reminders at your computer, not overnight wake-ups." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Is there a limit to how long the stopwatch can run?", a: "No practical limit - it keeps counting hours, minutes, seconds, and tenths for as long as the tab stays open, useful for tracking long tasks as well as short intervals." },
      { q: "How many laps can I record?", a: "There's no fixed cap - each click of Lap adds another entry to the list, so you can record as many splits as your activity needs, all displayed most recent first." },
      { q: "Is a browser stopwatch accurate enough for competitive timing?", a: "It's accurate to a tenth of a second for everyday use like workouts or presentations, but competitive or record-setting timing (races, official sports) requires certified hardware timers rather than a browser-based clock." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does this show seconds, or just hours and minutes?", a: "It displays down to the second, updating live each second, so you can use it for precise timing needs like coordinating a countdown, not just a general glance at the clock." },
      { q: "Can I use this to check the time in another country?", a: "This page only shows your own device's local time. To check the current time in a different city or time zone, use the Time Zone Converter instead." },
      { q: "Does the displayed date change automatically at midnight?", a: "Yes - since the page reads your system clock continuously, both the time and date update live, rolling over to the next calendar day the moment your device's clock crosses midnight." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can the same random date be generated twice if I ask for multiple dates?", a: "Yes - each date is picked independently, so with a wide enough range and enough picks, duplicates are possible, similar to rolling the same number twice on a die." },
      { q: "If I set the range to just one single day, what happens?", a: "Setting the start and end date to the same day returns that day every time, since there's only one possible date in the range to pick from." },
      { q: "How is this different from a 'random day of the week' generator?", a: "This tool picks a full calendar date (day, month, and year) from your chosen range, not just a weekday name - if you only need a random weekday, you'd want a simpler day-of-week picker instead." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate ARR if the control group event rate is 25% and the treatment group is 15%?", a: "ARR = 25% − 15% = 10 percentage points (0.10). RRR = 0.10 ÷ 0.25 = 40%. NNT = 1 ÷ 0.10 = 10, meaning about 10 people need treatment to prevent one additional event." },
      { q: "Why can RRR make a treatment sound more effective than ARR suggests?", a: "Because RRR is a ratio relative to the baseline rate, a treatment reducing a rare event from 0.2% to 0.1% has a dramatic-sounding 50% RRR but only a 0.1 percentage point ARR (and an NNT of 1,000) - both numbers are mathematically correct, but ARR better reflects the real-world impact on a population." },
      { q: "What does a negative ARR mean?", a: "A negative ARR means the treatment group actually had a higher event rate than the control group - the treatment appears harmful rather than beneficial for the outcome measured, and this calculator will show the reduction as negative to reflect that." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much does doubling the margin of error change the required sample size?", a: "It cuts the required sample size to roughly a quarter, since sample size is inversely proportional to the square of the margin of error (n ∝ 1/e²) - halving your desired margin of error, conversely, roughly quadruples the sample you need." },
      { q: "What sample size is needed for a 95% confidence level and 5% margin of error with an unknown proportion?", a: "About 385 - using n = (1.96² × 0.5 × 0.5) / 0.05² = 0.9604 / 0.0025 ≈ 384.16, rounded up to 385, the commonly cited figure for a general population survey." },
      { q: "Why does the calculator ask for an estimated response proportion if I don't have survey results yet?", a: "The proportion affects how much variability the formula assumes exists in responses - if you have a rough prior estimate (from past research or a pilot study), entering it can lower the required sample size compared to the conservative 50% default, since p×(1−p) is smaller the further p is from 0.5." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate a 99% confidence interval instead of 95%?", a: "Select 99% as the confidence level, which uses a larger z-score (about 2.576 instead of 1.96) - the resulting interval will be wider than a 95% interval for the same data, since higher confidence requires a larger margin of error." },
      { q: "What's the confidence interval for a sample mean of 50, standard deviation of 10, and n=100 at 95% confidence?", a: "Margin of error = 1.96 × (10/√100) = 1.96 × 1 = 1.96. The interval is 50 ± 1.96, or about 48.04 to 51.96." },
      { q: "Does a wider confidence interval mean the estimate is less accurate?", a: "It means there's more uncertainty about the true population mean's exact location, often because of a smaller sample size, higher variability in the data, or a higher chosen confidence level - it's not that the sample mean itself is wrong, just that the range of plausible true values is broader." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How does this calculator find the median for an even number of data points?", a: "It averages the two middle values after sorting the data. For the set 2, 4, 6, 8, the two middle numbers are 4 and 6, so the median is (4+6)/2 = 5." },
      { q: "What is the mean, median, and mode of 3, 7, 7, 9, 100?", a: "Mean = (3+7+7+9+100)/5 = 25.2. Median (middle of sorted list) = 7. Mode = 7 (appears twice). Notice how the single outlier (100) pulls the mean well above the median and mode." },
      { q: "Do I need to sort my numbers before entering them?", a: "No - this calculator sorts the data automatically to find the median and identify the range's minimum and maximum, so you can paste numbers in any order, separated by commas or line breaks." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens if I convert a time that falls during a DST transition, like the night clocks change?", a: "The tool applies whichever UTC offset is officially in effect for that zone at that exact date and time, so a time that doesn't exist (skipped during spring-forward) or occurs twice (repeated during fall-back) is resolved using the standard time zone database rules rather than left ambiguous." },
      { q: "How do I convert 2:00 PM Eastern to India time?", a: "Set the date and time to 14:00, choose US Eastern as the From zone and India (Kolkata) as the To zone - the result reflects the full offset (typically 9.5 or 10.5 hours depending on US daylight saving), including the half-hour that IST adds." },
      { q: "Is this the same as a 'UTC time converter'?", a: "Yes, in effect - selecting UTC as either the From or To zone converts directly to or from Coordinated Universal Time, which is what most 'UTC converter' tools do specifically." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's the exact date clocks change in 2026 for US Eastern?", a: "Select US Eastern and enter 2026 - the tool computes the second Sunday of March for the spring-forward date and the first Sunday of November for the fall-back date, per the current US rule." },
      { q: "Does this account for years before a time zone adopted DST, like historical dates?", a: "The calculator applies the DST rules currently in effect for the selected zone across the year range offered; it doesn't model historical rule changes (such as the US shifting its DST dates in 2007), so very old years may not reflect the rules actually used at the time." },
      { q: "Is 'daylight saving time' the same as 'summer time'?", a: "Yes - 'summer time' is the term commonly used in the UK and EU for the same clock-shifting practice called 'daylight saving time' in the US; this tool covers both under the DST label." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is 'civil twilight' and does this tool show it?", a: "Civil twilight is the period before sunrise or after sunset when the sun is up to 6° below the horizon and there's still usable natural light. This calculator reports the standard sunrise and sunset times (sun at the horizon) rather than separate twilight boundaries." },
      { q: "How much shorter is daylight in December compared to June for a city like London?", a: "London's day length swings from around 7.5 hours near the December solstice to about 16.5 hours near the June solstice - roughly a 9-hour difference caused by Earth's axial tilt, far more pronounced than at a city near the equator." },
      { q: "Why do sunrise and sunset times differ from what's shown in a generic weather app?", a: "Small differences (usually under a minute) can arise from rounding, atmospheric refraction assumptions, or slightly different reference coordinates for a city; the underlying solar position math is the same standard method used across most sources." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What altitude does the sun reach at solar noon in summer versus winter?", a: "At mid-latitude cities, solar noon altitude is much higher in summer (the sun can pass near-overhead) and much lower in winter (staying closer to the horizon even at its peak) - the exact angle depends on the city's latitude and the date's solar declination." },
      { q: "Can this tell me which direction to face to see the sunset?", a: "Yes - enter the date, time, and city near sunset, and the azimuth value (plus its compass direction like WNW) tells you exactly where on the horizon the sun sits at that moment." },
      { q: "Is 'sun angle calculator' the same thing as this tool?", a: "Yes - 'sun angle,' 'solar altitude,' and 'sun elevation' are different names for the same altitude value this calculator returns, describing how high the sun sits above the horizon." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many days are in February during a leap year?", a: "29 days, instead of the usual 28 - the extra day is always added to February specifically, which is why leap years have 366 total days instead of 365." },
      { q: "Was the year 2000 a leap year, given it's a century year?", a: "Yes - 2000 is divisible by 400 (not just 100), so it satisfies the century-year exception and counts as a leap year, unlike 1900 or 2100 which are divisible by 100 but not 400." },
      { q: "How do I find the next leap year after any given year, not just 2024?", a: "Enter any year above and the calculator finds the next one after it automatically - it checks each following year against the divisible-by-4/century/400 rule until it finds a match, typically within 4 years." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "If someone is 25 today, what are the two possible birth years?", a: "If the current year is 2026, they were born in either 2001 (if their birthday already passed this year) or 2000 (if it hasn't yet) - both are consistent with being 25 right now." },
      { q: "Can this handle an age given in months, like for a baby?", a: "No - this calculator works with whole years of age only. For a baby or young child's age in months, you'd need a tool that tracks age with finer granularity than a single birth year." },
      { q: "Why can't the calculator narrow it down to just one birth year?", a: "Age alone only tells you how many full years have elapsed since birth, not where in the calendar year the birthday falls - without that extra piece of information, both candidate years remain equally possible." },
    ],
    related: ["age-calculator", "days-until-calculator", "date-duration-calculator"],
  },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many minutes are in a week?", a: "10,080 minutes - 7 days × 24 hours × 60 minutes." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is 350°F in Celsius?", a: "About 177°C, though most recipes and oven dials round this to 180°C - the exact formula is (350 - 32) × 5/9 ≈ 176.7°C." },
      { q: "Why do converted oven temperatures often get rounded to values like 180°C instead of the exact math?", a: "Oven dials and recipe conventions use round, memorable numbers (180°C, 200°C, 220°C) rather than exact converted decimals, since ovens rarely hold temperature that precisely anyway - a couple of degrees of rounding has no practical effect on baking results." },
      { q: "Is 'oven temperature converter' the same thing as a 'gas mark to celsius converter'?", a: "Yes - gas mark is just one of the temperature scales this tool converts, alongside Celsius and Fahrenheit, so searching for a gas-mark-specific converter and using this general oven temperature converter get you the same result." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I calculate a 3:1 mix for 500ml total?", a: "500 ÷ (3+1) = 125 per unit. Part A = 125 × 3 = 375ml, Part B = 125 × 1 = 125ml." },
      { q: "What if my container only measures one component - can I still hit the ratio?", a: "Yes - measure out Part A to the amount this calculator gives, then add Part B up to that same combined total if you're using a single graduated container, or measure both separately if precision matters more, such as with fast-curing epoxy where getting the ratio slightly wrong affects cure quality." },
      { q: "How is a mix ratio like 2:1 different from a percentage-based ratio like 33%?", a: "A 2:1 ratio means for every 2 parts of A there's 1 part of B, while a percentage ratio states each component's share of the whole - 2:1 is equivalent to Part A being 66.7% and Part B being 33.3% of the total, which this calculator's 'ratio simplified' output can help you cross-check." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much water can I collect from a 50m² roof during 1 inch of rain?", a: "About 1,270 liters - 1 inch equals 25.4mm, and 25.4mm × 50m² = 1,270 liters, since each 1mm-over-1m² unit equals 1 liter." },
      { q: "Should I use my roof's footprint area or its sloped surface area?", a: "Use the horizontal footprint (the area as seen from directly above), not the sloped roof surface area - rainfall is measured as vertical depth falling onto a horizontal plane, so a sloped roof collects the same volume as a flat roof of the same footprint, just spread over more physical roof material." },
      { q: "How is this different from a rainwater harvesting or tank sizing calculator?", a: "This tool only converts rainfall depth and area into a volume of water produced - it doesn't account for tank capacity, first-flush diversion, or overflow, which a dedicated rainwater harvesting sizing calculator would factor in for planning a storage system." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What's an example calculation for a different activity?", a: "Cycling at a moderate pace (MET 8.0) for a 180 lb (81.6 kg) person for 45 minutes (0.75 hours): 8.0 × 81.6 × 0.75 ≈ 490 calories burned." },
      { q: "Why do two similar activities have very different MET values?", a: "MET values reflect measured average energy cost at a specific intensity - brisk walking (MET ~4) and running (MET ~10) both involve similar muscles, but running requires far more energy output per minute, which is captured in its higher MET value." },
      { q: "Is this the same as what my fitness tracker or gym machine shows?", a: "It's a similar MET-based estimate, though trackers and machines may use slightly different MET tables or incorporate heart rate data, which can produce a somewhat different number for the same activity and duration - both are estimates rather than precise measurements." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is the density of boiling water (100°C)?", a: "About 958.4 kg/m³ - notably lower than water's density at room temperature (998.2 kg/m³ at 20°C), since water expands and becomes less dense as it's heated toward its boiling point." },
      { q: "Why would I need to know water's density at different temperatures?", a: "Precise density matters for calibrating lab instruments, calculating buoyancy, converting between volume and mass in scientific or brewing contexts, and hydraulic engineering - everyday uses like cooking rarely need more precision than the standard 1 kg/liter approximation." },
      { q: "Does altitude or air pressure affect water's density?", a: "Only very slightly under normal conditions - pressure has a much smaller effect on liquid water's density than temperature does, since water is nearly incompressible. This calculator accounts for temperature only, which is the dominant factor for everyday and most scientific purposes." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I find the absolute magnitude if I know apparent magnitude and distance?", a: "M = m − 5×log₁₀(d) + 5, where d is in parsecs. For an apparent magnitude of 8 at a distance of 50 parsecs: M = 8 − 5×log₁₀(50) + 5 = 8 − 8.49 + 5 ≈ 4.51." },
      { q: "Why does a larger distance modulus mean a more distant object?", a: "Because apparent brightness fades with distance (following the inverse square law) while absolute magnitude is fixed for a given object, a bigger gap between how bright something looks (m) versus its true brightness (M) can only come from it being farther away." },
      { q: "Can the distance modulus be negative?", a: "Yes - a negative distance modulus (m less than M) means the object is closer than 10 parsecs, since it appears brighter than its standard absolute-magnitude reference distance would suggest. This is common for very nearby stars." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much more energy does a magnitude 9 earthquake release than a magnitude 6?", a: "About 31,623 times more - a 3-point magnitude difference means (10^1.5)³ = 10^4.5 ≈ 31,623 times the energy, since each whole point multiplies energy by roughly 31.6×." },
      { q: "Can this calculator compare a fractional magnitude difference, like 6.5 versus 6.0?", a: "Yes - enter both magnitudes as decimals and the formula energy = 10^(1.5×M + 4.8) handles any fractional value, giving an energy ratio of 10^(1.5×0.5) ≈ 5.6 times more energy for a 0.5-point increase." },
      { q: "Does a higher magnitude always mean more damage?", a: "Not necessarily - magnitude measures total energy released at the source, but felt damage also depends on depth, distance from populated areas, soil type, and building construction, so a smaller, shallow, nearby earthquake can sometimes cause more damage than a larger, deep, or remote one." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What pressure altitude results from a field elevation of 500 ft with an altimeter setting of 30.42?", a: "0 ft - since (29.92 − 30.42) × 1,000 = −500, adding that to the 500 ft elevation gives exactly 0. A higher-than-standard altimeter setting reduces pressure altitude below field elevation." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I check if a meeting time falls outside normal working hours for an attendee?", a: "The tool shows each attendee's exact local time and date for your chosen meeting slot, so you can see at a glance if it lands late at night or early morning for them - it doesn't flag this automatically, so compare the displayed times against typical 9-to-5 hours yourself." },
      { q: "What if two of my attendees are in the same time zone?", a: "You can select the same zone for more than one attendee slot - the tool will simply display identical local times for both, which is useful for confirming everyone in that region sees the same schedule." },
      { q: "Is this similar to a 'world clock meeting planner' or 'schedule across time zones' tool?", a: "Yes - those are common ways to describe the same task this tool performs: picking one meeting time and instantly seeing what it looks like on the clock in several other locations at once." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I convert a 700W recipe time to a 1000W microwave?", a: "Multiply the original time by (700 ÷ 1000) = 0.7. A 5-minute recipe at 700W needs about 3.5 minutes at 1000W - going to a higher wattage always shortens the time." },
      { q: "Does doubling the wattage cut the cooking time exactly in half?", a: "In theory, yes, based on the inverse power-to-time relationship this calculator uses - but in practice, very short adjusted times (especially under a minute) can undercook food unevenly, so it's worth checking doneness rather than trusting the halved time exactly." },
      { q: "Is 'microwave wattage converter' the same as a 'microwave cooking time calculator'?", a: "Yes, functionally - both describe adjusting a stated cook time from one microwave's power rating to another's, which is exactly what this tool does." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much does it cost to run a 1500W space heater for 8 hours a day?", a: "At $0.15/kWh: about $1.80 per day, or roughly $54 over 30 days - 1500W × 8 hours = 12 kWh per day, times $0.15." },
      { q: "Does standby power (phantom load) get included in this calculation?", a: "No - this calculator assumes the device only draws power during the hours you specify. Many electronics continue drawing a small amount of standby power even when 'off,' which this tool doesn't account for unless you add that time separately." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Where is simple interest actually used?", a: "Some short-term loans, certain bonds, and basic promissory notes use simple interest, since it's straightforward to calculate. Most savings accounts, credit cards, and <a href=\"/tool/mortgage-calculator\">mortgages</a> use compound interest instead." },
      ...
      { q: "How much total will I repay on a $2,000 loan at 4% simple interest over 5 years?", a: "Interest = $2,000 × 0.04 × 5 = $400, so total repayment is $2,000 + $400 = $2,400 - simple interest stays flat each year since it's always calculated on the original $2,000, not a growing balance." },
      { q: "Can I use this calculator for a time period in months instead of years?", a: "Convert months to years first by dividing by 12 - for a 6-month period, enter 0.5 for time, since the formula (principal × rate × time) expects time in years to match the annual interest rate." },
      { q: "Is a simple interest calculator useful for a savings account?", a: "Rarely - most savings accounts compound interest (typically daily or monthly), so a simple interest calculation would understate actual growth. Simple interest calculators are more accurate for products explicitly structured that way, like some short-term promissory notes or certain installment loans." },
    ],
    related: ["compound-interest-calculator", "savings-calculator", "loan-calculator"],
  },
  {
    ...
    faq: [
      ...
      { q: "How do I find a circle's diameter if I know its area?", a: "First find the radius with radius = √(area ÷ π), then double it for the diameter. For an area of 78.54: radius = √(78.54/π) ≈ 5, so diameter = 10." },
      { q: "What is the diameter of a circle with a circumference of 31.42?", a: "About 10 - diameter = circumference ÷ π = 31.42 ÷ π ≈ 10, since circumference always equals π times the diameter." },
      { q: "Why does area grow faster than circumference as radius increases?", a: "Circumference scales linearly with radius (2πr) while area scales with radius squared (πr²) - so doubling the radius only doubles the circumference but quadruples the area, which is why larger circles hold disproportionately more area relative to their edge length." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Will shuffling the same list twice give the same result?", a: "No - each shuffle draws fresh random values, so running the tool again on the same input list produces a new, independent random order each time." },
      { q: "If I shuffle a 5-item list, how many possible orders are there?", a: "120 (5 factorial: 5×4×3×2×1). Fisher-Yates gives each of those 120 orderings an equal chance of being the result." },
      { q: "Is this the same as a 'randomize order' or 'randomize list' tool?", a: "Yes - 'list shuffler,' 'randomize list order,' and 'random list sorter' all describe the same task: taking a list and outputting it in a random sequence, which is exactly what this tool does." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is 1% as ppm?", a: "10,000 ppm - since 1 ppm equals 0.0001%, multiplying 1% by 10,000 gives the ppm equivalent." },
      { q: "Why is chlorine in pool water measured in ppm instead of percent?", a: "Effective pool chlorine levels (typically 1-3 ppm free chlorine) are far too small to express meaningfully in percent (0.0001%-0.0003%) - ppm avoids awkward decimal percentages for concentrations that are naturally tiny." },
      { q: "Is ppm the same unit regardless of what's being measured (gas, liquid, solid)?", a: "The ratio itself (1 part in a million) is the same, but the underlying basis can differ - ppm can be by mass, volume, or mole fraction depending on context (e.g., air pollutant ppm is usually by volume, while contaminants in water are usually by mass/weight), so always check which basis a specific measurement uses before comparing values." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How do I enter a decimal like 2.5555... that has a whole number part?", a: "Enter just the decimal portion - non-repeating digits \"5\" would be wrong here since the 5 itself repeats, so leave non-repeating empty and enter \"5\" as repeating, getting 5/9, then add the whole number 2 separately to get 2 + 5/9 = 23/9." },
      { q: "What is 0.8333... (0.8 with 3 repeating) as a fraction?", a: "5/6 - with non-repeating digit \"8\" and repeating digit \"3\": numerator = 83 − 8 = 75, denominator = 900 − 100 = 800... using the simpler rule (100−10)=90 for one repeating digit after one non-repeating digit: 75/90 simplifies to 5/6." },
      { q: "Can every repeating decimal be written as an exact fraction?", a: "Yes - any decimal that eventually repeats forever is by definition a rational number, meaning it can always be expressed as a ratio of two integers. Only non-repeating, non-terminating decimals (like π) are irrational and can't be converted this way." },
    ],
    related: ["fraction-calculator", "gcd-lcm-calculator", "percentage-calculator"],
  },
  {
    ...
    faq: [
      ...
      { q: "What is 5 choose 5 (5C5), and why does it equal 1?", a: "1 - there's only one way to choose all 5 items from a group of 5 (you simply take everyone), which the formula confirms: 5!/(5!×0!) = 1, since 0! is defined as 1." },
      { q: "How many different 4-letter arrangements can be made from 6 distinct letters?", a: "360 - using nPr = n!/(n-r)! = 6!/(6-4)! = 720/2 = 360, since order matters for an arrangement (permutation)." },
      { q: "Why is nCr always the same value whether you compute it as 'n choose r' or 'n choose (n-r)'?", a: "Choosing r items to include is mathematically identical to choosing the (n-r) items to leave out - for example, 10C3 = 10C7 = 120, because both describe the same act of splitting 10 items into a group of 3 and a group of 7." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens if I give an item a weight of 0?", a: "It's included in the list but can never be selected - a weight of 0 means a 0% share of the total, so the picker effectively skips it while still displaying it as an option." },
      { q: "If I have three items each weighted 1, what are the odds for each?", a: "Exactly 1/3 (about 33.3%) each, since the weights are equal - the total is 3, and each item's share is 1 divided by 3, regardless of what the actual weight numbers are." },
      { q: "How is this different from a 'random name picker' or 'wheel spinner'?", a: "A plain random name picker or wheel spinner gives every entry an equal chance. This tool is for when outcomes shouldn't be equally likely - like a loot table where rare items should come up less often than common ones." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many bytes are in a kilobyte?", a: "1,024 bytes, using the binary convention (2^10) this calculator applies - not 1,000, which is the decimal convention some manufacturers use for marketing storage capacity." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is standard atmospheric pressure in PSI?", a: "About 14.7 PSI - 1 atmosphere (atm) equals approximately 14.696 PSI, the reference pressure at sea level." },
      { q: "Why do some tire gauges read 0 at atmospheric pressure instead of 14.7 PSI?", a: "Most tire gauges measure gauge pressure (pressure above the surrounding atmosphere), not absolute pressure - so a gauge reading of 32 PSI actually means about 46.7 PSI absolute. This converter works in gauge pressure terms, matching what your tire gauge and this tool's PSI/bar/kPa readings show." },
      { q: "How many bar is 1 kPa?", a: "0.01 bar - 1 bar equals exactly 100 kPa, so kPa values are simply divided by 100 to get bar." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How many inch-pounds is 100 Nm?", a: "About 885.1 in-lb - 100 Nm × 8.851 (the Nm-to-in-lb factor), useful for small-fastener specs given in newton-meters." },
      { q: "Is more torque always better when tightening a bolt?", a: "No - both under-tightening and over-tightening are problems. Manufacturer torque specs (whether in Nm, ft-lb, or in-lb) exist because over-torquing can strip threads or warp parts, while under-torquing risks the fastener loosening over time, so matching the exact spec matters more than 'more is better.'" },
      { q: "How many ft-lb is 12 in-lb?", a: "Exactly 1 ft-lb - inch-pounds convert to foot-pounds by dividing by 12, since a foot-pound is defined as 12 inch-pounds of torque." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is 9.41 L/100km in MPG?", a: "About 25 MPG - divide 235.214 by the L/100km value (235.214 ÷ 9.41 ≈ 25), the same inverse relationship used to go from MPG to L/100km." },
      { q: "Is 'MPG (US)' the same as 'MPG (UK/Imperial)'?", a: "No - a US gallon (3.785 liters) is smaller than an imperial gallon (4.546 liters), so the same fuel efficiency in real-world terms produces a different MPG number depending on which gallon is used. This calculator uses US MPG; converting from imperial MPG requires an extra gallon-size adjustment first." },
      { q: "What L/100km rating counts as fuel-efficient for a typical car?", a: "Roughly 6-8 L/100km (about 29-39 MPG) is typical for an efficient gas-powered sedan, with hybrids often reaching 4-5 L/100km (47-59 MPG) and larger SUVs or trucks commonly landing at 10-14 L/100km (17-24 MPG)." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What speed does 90 rpm cadence produce with a 50/14 gear on a 27-inch wheel?", a: "About 26 mph - the gear inches are 27 × (50÷14) ≈ 96.4, each pedal revolution covers 96.4 × π ≈ 302.9 inches, and at 90 rpm that's 27,264 inches per minute, which converts to roughly 25.8 mph." },
      { q: "Why do gear inches use the wheel diameter instead of the tire's actual rolling diameter?", a: "This calculator uses the nominal wheel diameter you enter as an approximation - the true rolling diameter (which includes tire size and slight compression under load) differs slightly, so gear-inch figures are a standardized comparison tool rather than a precise real-world distance measurement." },
      { q: "Is 'gear inches' the same measurement as 'development' or 'roll-out' used in some cycling computers?", a: "They're related but not identical - development (or roll-out) is the actual distance traveled per pedal revolution, typically given in meters or inches, while gear inches is a slightly different traditional unit (effective wheel diameter). Development equals gear inches × π, which is exactly the relationship this calculator uses internally to derive speed." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much bigger is a 235/40R18 tire than a 225/45R17?", a: "It depends on the specific combination - you need to calculate overall diameter for both (width × aspect ratio × 2, converted to inches, plus rim diameter) since a wider tire with a lower aspect ratio can end up close in overall size to a narrower tire with a taller sidewall, which is exactly the comparison this calculator performs." },
      { q: "If my new tire's diameter is 2% larger, will my speedometer read low or high?", a: "Your speedometer will read lower than your actual speed - a larger tire covers more ground per rotation, so at any given speedometer reading (based on wheel rotations) you're actually traveling faster than the display shows." },
      { q: "Is 'plus sizing' the same thing as what this calculator compares?", a: "Yes - plus sizing refers to fitting a larger-diameter wheel with a lower-profile (lower aspect ratio) tire while keeping the overall tire diameter close to stock, which is exactly the width/aspect/rim tradeoff this calculator lets you check between two tire specs." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "At what dew point does it start to feel muggy?", a: "Most people start noticing humidity as uncomfortable around a 60-65°F dew point, with 70°F+ considered oppressive - below 55°F generally feels comfortable regardless of the air temperature." },
  ...
  // ---------------- TEXT & DIGITAL ----------------
  {
    ...
    faq: [
      ...
      { q: "Does a hyphenated word like 'well-known' count as one word or two?", a: "One word - the counter splits on whitespace, and since there's no space inside 'well-known,' it's treated as a single word, matching how most word processors handle hyphenated compounds." },
      { q: "If I paste in three blank lines between paragraphs, does that affect the count?", a: "Extra blank lines don't add to the word or character count (there are no words on them), but they do count toward paragraph detection, since a blank line is typically what separates one paragraph from the next." },
      { q: "How is 'word count' different from 'character count' for things like Twitter/X limits?", a: "Word count tallies whitespace-separated words, while character count tallies every individual letter, number, space, and symbol. Platforms like X limit by character count, not word count, so check the character count (with spaces) this tool shows if you're working against a platform's character limit." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "If I uncheck all the character type options, what happens?", a: "You need at least one character type selected for a password to be generated - with nothing checked there's no character pool to draw from, so leave at least one of uppercase, lowercase, numbers, or symbols enabled." },
      { q: "Does increasing the length matter more than adding more character types?", a: "Generally yes - for example, a 20-character password using only lowercase letters and numbers has a larger search space for an attacker to brute-force than a 10-character password using all four character types, because each added character multiplies the possibilities exponentially while each added character type only multiplies them by a small constant factor." },
      { q: "Is this the same as a 'random password generator' or 'strong password generator'?", a: "Yes - those are all names for the same kind of tool: generating passwords from a random character pool rather than a human-chosen phrase, which is exactly what this generator does using your browser's random number generator." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I use a UUID as a database primary key?", a: "Yes, this is one of the most common uses - UUIDs let you generate unique IDs independently across multiple servers or services without checking a central database first, avoiding the collisions that could happen with simple auto-incrementing numbers in a distributed system." },
      { q: "Do the UUIDs generated here always follow the same format, like 8-4-4-4-12?", a: "Yes - every UUID follows the standard 36-character format of five hyphen-separated hex groups (8-4-4-4-12 digits), which is the RFC 4122 layout that databases, APIs, and libraries expect to parse." },
      { q: "Is a GUID the same thing as a UUID?", a: "Functionally yes - GUID (Globally Unique Identifier) is Microsoft's term for the same 128-bit identifier concept as a UUID, and the two terms are used interchangeably in most contexts, including by this generator's output." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I simulate a weighted coin, like 70/30 instead of 50/50?", a: "No - this tool flips a fair coin with an even 50/50 chance on every flip. For uneven odds, use a tool built for custom probabilities, like a weighted random picker." },
      { q: "If I flip 100 coins, will it be exactly 50 heads and 50 tails?", a: "Usually not exactly - with a fair 50/50 coin, 100 flips will land close to 50/50 on average, but the actual count naturally varies flip to flip (for example, 46 heads and 54 tails is a perfectly normal result)." },
      { q: "Is this the same as a 'heads or tails' generator?", a: "Yes - 'coin flip,' 'coin toss,' and 'heads or tails generator' all refer to the same simple 50/50 random choice between two outcomes, which is what this tool simulates." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I roll dice that don't exist physically, like a D7 or D13?", a: "Yes - since \"sides per die\" accepts any number from 2 to 100, you can simulate dice with side counts that don't exist as physical objects, useful for custom games or probability experiments." },
      { q: "How do I roll something like 4d10, and what does that notation mean?", a: "Set \"number of dice\" to 4 and \"sides per die\" to 10. In tabletop notation, \"4d10\" means \"roll four 10-sided dice,\" and the number before the d is always the dice count while the number after is the side count." },
      { q: "Is a roll of the same number on every die, like all sixes, suspicious?", a: "No - each die roll is independent, so getting the same result on multiple dice happens by chance sometimes, especially with fewer sides per die (a 6-sided die has a 1-in-6 chance of matching another 6-sided die's roll)." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "If I draw fewer than 52 cards, could I get the same card twice?", a: "No - drawing pulls cards from a single shuffled 52-card deck without replacement, so every card drawn in one run is guaranteed unique, just like dealing from a real deck." },
      { q: "Can I use this to deal a hand for a specific game, like blackjack or bridge?", a: "Yes - set \"cards to draw\" to the hand size you need (2 for a blackjack starting hand, 13 for a bridge hand) and the tool draws that many cards from a freshly shuffled deck, though for multi-player games you'd run separate draws or split the drawn cards yourself." },
      { q: "How is this different from a 'random card generator'?", a: "They're closely related: a random card generator often pulls a single card independently (which could repeat on a second pull), while this shuffler draws from one full deck without replacement, matching how a physical deck of cards actually behaves when dealt." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What color do you get from mixing pure red and pure blue at 50/50?", a: "A mid-purple/magenta, roughly #7F007F - since red is (255,0,0) and blue is (0,0,255), averaging each channel gives (127,0,127), the RGB midpoint between the two." },
      { q: "Why doesn't mixing red and green give brown or yellow like paint would?", a: "Because this tool blends light (additive RGB), not pigment (subtractive mixing). Additively, red (255,0,0) and green (0,255,0) mixed 50/50 average to (127,127,0), a yellow-olive tone - similar to yellow, but by an entirely different mechanism than mixing paint pigments, which is why intuitions from painting don't always transfer here." },
      { q: "What happens if I set the ratio to 0% or 100%?", a: "At 0% first-color weight, the output is simply the second color unchanged; at 100%, it's the first color unchanged - the ratio only matters for values between those two extremes." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How does title case decide which words to capitalize?", a: "It capitalizes the first letter of every word in the text, without special handling for smaller words like 'a,' 'the,' or 'of' - so 'the lord of the rings' becomes 'The Lord Of The Rings' here, rather than the style-guide convention that lowercases minor words." },
      { q: "What does sentence case do with a text that has multiple sentences?", a: "It capitalizes only the very first letter of the entire input, leaving everything else lowercase - it doesn't detect individual sentence boundaries and re-capitalize each one, so a multi-sentence paragraph gets exactly one capital letter overall." },
      { q: "If my text has ALL CAPS acronyms like 'NASA,' does converting to lowercase break them?", a: "Yes - converting to lowercase treats every letter the same way regardless of context, so 'NASA' becomes 'nasa.' There's no acronym detection, so review text with acronyms or proper nouns after converting." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can I control exactly how long each paragraph is?", a: "Yes, approximately - the \"words per paragraph\" setting controls the target word count for each paragraph, from 5 up to 200 words, letting you roughly match how much text a design mockup needs to fill." },
      { q: "Does the generated text repeat the same sentences every time?", a: "The output is built from the traditional Lorem Ipsum word/phrase pool, so wording will look familiar across generations, though the arrangement and paragraph lengths change based on your paragraph count and words-per-paragraph settings." },
      { q: "Can I use Lorem Ipsum text in a real, published website?", a: "It's meant strictly as placeholder text for mockups and drafts, not final content - Lorem Ipsum has no real meaning and won't help readers or search engines, so replace it with real copy before a design goes live." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What happens to punctuation like apostrophes or exclamation points in my text?", a: "They're stripped out entirely, since a slug only keeps lowercase letters, numbers, and hyphens - \"Joe's Pizza!\" becomes \"joes-pizza\" rather than keeping the apostrophe or exclamation mark." },
      { q: "Are multiple spaces or repeated punctuation collapsed into one hyphen?", a: "Yes - consecutive spaces or special characters collapse into a single hyphen rather than producing several hyphens in a row, so \"Hello   World!!\" becomes \"hello-world,\" not \"hello---world.\"" },
      { q: "Is 'slugify' the same thing as what this tool does?", a: "Yes - \"slugify,\" \"URL slug generator,\" and \"convert to slug\" all describe converting arbitrary text into the lowercase, hyphenated, URL-safe format this tool produces." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does punctuation attached to a word, like 'dog,' or 'dog.', get counted separately from 'dog'?", a: "No - punctuation is stripped before counting, so \"dog,\" \"dog.\" and \"dog\" are all tallied as the same word, avoiding artificially split counts caused by trailing commas or periods." },
      { q: "In the example text, how many times does 'the' appear?", a: "Twice - \"the quick brown fox jumps over the lazy dog the fox runs fast\" actually has 'the' three times (before 'quick,' before 'lazy,' and before second 'fox'), each counted the same regardless of position in the sentence." },
      { q: "Is this the same as a 'keyword density checker'?", a: "They're closely related - a keyword density checker usually expresses a target word's frequency as a percentage of total words, while this tool ranks all words by raw frequency count. You can manually compute density from the counts and total word count this tool provides." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does the & character become when encoded?", a: "%26 - since & has special meaning in URLs (separating query parameters), it needs to be percent-encoded to %26 whenever it appears as literal data rather than as an actual parameter separator." },
      { q: "If I encode a URL that's already fully valid, like https://example.com, does it break it?", a: "Encoding is meant for individual values (like a search query), not whole URLs - running a complete URL through this tool's encode mode will also convert its own slashes and colons (: becomes %3A, / becomes %2F), breaking it as a clickable link. Only encode the parameter value itself, not the surrounding URL structure." },
      { q: "Can I decode a URL that has both %20 and + representing spaces?", a: "This tool's decode mode converts %XX percent-sequences back to their original characters, but a literal + in a query string is a separate legacy convention for spaces that percent-decoding alone won't touch - if your input mixes both conventions, you may need to replace + with a space manually before or after decoding." },
    ],
    related: ["word-counter", "text-to-slug-generator", "case-converter"],
  },
  {
    ...
    faq: [
      ...
      { q: "How does the CIDR prefix length change if I switch from /24 to /25?", a: "A /25 splits what would be one /24 network into two smaller subnets, each with 128 total addresses (126 usable hosts) instead of 256 (254 usable) - moving to a longer prefix always shrinks the address space per subnet while creating more subnets overall." },
      { q: "What's the usable host range for 192.168.1.0/24?", a: "192.168.1.1 through 192.168.1.254 - the network address (192.168.1.0) and broadcast address (192.168.1.255) are excluded, leaving 254 assignable host addresses in between." },
      { q: "Is 'IP subnet calculator' the same tool as a 'CIDR calculator'?", a: "Yes, essentially - both take an IP address and a prefix length (or combined CIDR notation) and compute the same network address, broadcast address, and usable host range; this tool takes the IP and prefix as separate fields rather than combined slash notation." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "If a key exists in both JSON objects but has the exact same value, does it show up in the diff?", a: "No - only keys that differ (added, removed, or changed in value) appear in the results. Identical keys with identical values are considered unchanged and aren't flagged." },
      { q: "In the default example, what's the difference between the two JSON objects?", a: "\"age\" is changed (30 to 31), \"city\" is removed (only in the first JSON), and \"country\" is added (only in the second JSON) - \"name\" stays the same in both, so it's not flagged." },
      { q: "Does key order in the JSON matter for the comparison?", a: "No - the comparison is based on key names and values, not the order keys appear in the text, since JSON objects are inherently unordered collections of key-value pairs by specification." },
    ],
    related: ["word-counter", "text-to-slug-generator", "case-converter"],
  },
  {
    ...
    faq: [
      ...
      { q: "What's the subnet mask for a /24 network?", a: "255.255.255.0 - a /24 prefix means the first 24 bits are all 1s (three full octets of 255), leaving the last octet as all 0s for host addresses." },
      { q: "How is this different from the IP Subnet Calculator?", a: "They compute the same results (network address, broadcast address, usable range), but this tool takes input as a single combined CIDR string like \"192.168.1.0/24,\" while the IP Subnet Calculator uses separate fields for the IP address and prefix length." },
      { q: "What subnet mask corresponds to a /29 network?", a: "255.255.255.248 - a /29 prefix uses 29 of the 32 bits for the network, leaving only 3 host bits (8 total addresses, 6 usable), which as a mask is 255.255.255 followed by 248 (11111000 in binary)." },
    ],
  ...
  // ---------------- PET & LIFESTYLE ----------------
  {
    ...
    faq: [
      ...
      { q: "What's the difference between 'dog years' and this calculator's human-year equivalent?", a: "'Dog years' usually refers to the flawed 7:1 multiplier. This calculator instead applies a curve that front-loads aging in the first two years and adjusts the later rate by size class, which is much closer to how veterinarians actually describe canine aging." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much food does a working or very active dog need compared to a moderate one?", a: "An active/working dog typically needs a higher activity multiplier applied to RER, often 20-40% more calories than a moderately active dog of the same weight - a 40 lb working dog can need well over 3 cups a day versus roughly 2.8 cups at moderate activity." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How old is a 1-year-old kitten in human years?", a: "A 1-year-old cat is roughly equivalent to a 15-year-old human - the first year covers most of a cat's rapid growth to near-adult size, which is why the early curve is much steeper than later years." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Is a 6-month-old rabbit already an adult in human-year terms?", a: "Close to it - rabbits reach a large share of their adult-equivalent age within the first year, so a 6-month-old rabbit is already roughly comparable to a young adult human, well ahead of where a dog or cat of the same age would land." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Why does the calculator let me change the gestation length instead of fixing it at 63 days?", a: "Actual canine gestation varies by a few days between dogs and even between litters of the same dog, so adjusting the gestation length field lets you refine the due date estimate if your vet has given you a more specific timeline from ovulation testing." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How does horse aging compare to dog or cat aging?", a: "Horses front-load maturity dramatically, reaching a human-equivalent age in the low teens by just their second year, then age more steadily afterward - a pattern broadly similar to dogs and cats but stretched over a longer overall lifespan." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What does a body condition score of 4 or 5 mean for the calculation?", a: "A BCS of 4-5 is treated as ideal, so the calculator returns the current weight unchanged - there's no estimated excess to subtract because the dog is already considered at a healthy weight." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Why is the default gestation length 64 days for cats but different from dogs?", a: "Feline and canine gestation lengths are close but not identical - cats average about 64 days versus roughly 63 for dogs - so the calculator uses species-appropriate defaults, though you can adjust the field if your vet gives a more specific estimate." },
